...
export class ReportingController {
  ...
  async getExecutiveDashboards(req: Request, res: Response): Promise<void> {
    try {
      ...
      const processedData = await this.businessLogic.processExecutiveDashboards(
        parameters,
        userContext
      );
  ...
  async getPerformanceAnalytics(req: Request, res: Response): Promise<void> {
    try {
      ...
      const processedData = await this.businessLogic.processPerformanceAnalytics(
        parameters,
        userContext
      );
  ...
  async getBusinessMetrics(req: Request, res: Response): Promise<void> {
    try {
      ...
      const processedData = await this.businessLogic.processBusinessMetrics(
        parameters,
        userContext
      );
  ...
  async getComparativeReports(req: Request, res: Response): Promise<void> {
    try {
      ...
      const processedData = await this.businessLogic.processComparativeReports(
        parameters,
        userContext
      );
  ...
  async getDrillDownAnalytics(req: Request, res: Response): Promise<void> {
    try {
      ...
      const processedData = await this.businessLogic.processDrillDownAnalytics(
        parameters,
        userContext
      );
  ...
  async getProfitLossReports(req: Request, res: Response): Promise<void> {
    try {
      ...
      const processedData = await this.businessLogic.processProfitLossReports(
        parameters,
        userContext
      );
  ...
  async scheduleReports(req: Request, res: Response): Promise<void> {
    try {
      ...
      const scheduledJob = await this.reportingService.scheduleReports(scheduleConfig, userContext);
