...
export class CRMLeadService {
   ...
   */
  async createNurturingCampaign(campaign: Omit<LeadNurturingCampaign, 'id'>): Promise<LeadNurturingCampaign> {
  ...
  private async createOpportunityFromLead(leadId: string, opportunityId: string, _data: any): Promise<void> {
