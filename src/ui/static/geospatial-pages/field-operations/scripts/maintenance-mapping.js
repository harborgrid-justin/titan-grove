...
function handlemaintenancemappingAction() {
  ...
  window.geospatialPages.showNotification(
    'Maintenance Location Planning configured successfully',
    'success'
  );
}
...
function executemaintenancemapping() {
  ...
  window.geospatialPages.showNotification(
    'Maintenance Location Planning operation initiated',
    'info'
  );
  ...
  setTimeout(() => {
    window.geospatialPages.showNotification(
      'Maintenance Location Planning operation completed successfully',
      'success'
    );
  }, 2000);
}
