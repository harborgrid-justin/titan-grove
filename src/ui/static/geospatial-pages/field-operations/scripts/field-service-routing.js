...
function handlefieldserviceroutingAction() {
  ...
  window.geospatialPages.showNotification(
    'Field Service Route Optimization configured successfully',
    'success'
  );
}
...
function executefieldservicerouting() {
  ...
  window.geospatialPages.showNotification(
    'Field Service Route Optimization operation initiated',
    'info'
  );
  ...
  setTimeout(() => {
    window.geospatialPages.showNotification(
      'Field Service Route Optimization operation completed successfully',
      'success'
    );
  }, 2000);
}
