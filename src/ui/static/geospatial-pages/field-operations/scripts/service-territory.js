...
function handleserviceterritoryAction() {
  ...
  window.geospatialPages.showNotification(
    'Service Territory Optimization configured successfully',
    'success'
  );
}
...
function executeserviceterritory() {
  ...
  window.geospatialPages.showNotification(
    'Service Territory Optimization operation initiated',
    'info'
  );
  ...
  setTimeout(() => {
    window.geospatialPages.showNotification(
      'Service Territory Optimization operation completed successfully',
      'success'
    );
  }, 2000);
}
