...
function handlesuppliermappingAction() {
    ...
    window.geospatialPages.showNotification('Supplier Network Mapping configured successfully', 'success');
}
...
function executesuppliermapping() {
    ...
    setTimeout(() => {
        window.geospatialPages.showNotification('Supplier Network Mapping operation completed successfully', 'success');
    }, 2000);
}
