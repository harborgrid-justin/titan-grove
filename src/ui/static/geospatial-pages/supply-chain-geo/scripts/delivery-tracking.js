...
function handledeliverytrackingAction() {
  ...
  window.geospatialPages.showNotification(
    'Delivery Tracking & Optimization configured successfully',
    'success'
  );
}
...
function executedeliverytracking() {
  ...
  window.geospatialPages.showNotification(
    'Delivery Tracking & Optimization operation initiated',
    'info'
  );
  ...
  setTimeout(() => {
    window.geospatialPages.showNotification(
      'Delivery Tracking & Optimization operation completed successfully',
      'success'
    );
  }, 2000);
}
