...
function handledistributionanalysisAction() {
  ...
  window.geospatialPages.showNotification(
    'Distribution Network Analysis configured successfully',
    'success'
  );
}
...
function executedistributionanalysis() {
  ...
  window.geospatialPages.showNotification(
    'Distribution Network Analysis operation initiated',
    'info'
  );
  ...
  setTimeout(() => {
    window.geospatialPages.showNotification(
      'Distribution Network Analysis operation completed successfully',
      'success'
    );
  }, 2000);
}
