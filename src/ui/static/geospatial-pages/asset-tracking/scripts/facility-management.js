...
function handlefacilitymanagementAction() {
  ...
  window.geospatialPages.showNotification(
    'Facility & Space Management configured successfully',
    'success'
  );
}
...
function executefacilitymanagement() {
  ...
  window.geospatialPages.showNotification(
    'Facility & Space Management operation initiated',
    'info'
  );
  ...
  setTimeout(() => {
    window.geospatialPages.showNotification(
      'Facility & Space Management operation completed successfully',
      'success'
    );
  }, 2000);
}
