...
function handlesecuritymonitoringAction() {
  ...
  window.geospatialPages.showNotification(
    'Security & Access Monitoring configured successfully',
    'success'
  );
}
...
function executesecuritymonitoring() {
  ...
  window.geospatialPages.showNotification(
    'Security & Access Monitoring operation initiated',
    'info'
  );
  ...
  setTimeout(() => {
    window.geospatialPages.showNotification(
      'Security & Access Monitoring operation completed successfully',
      'success'
    );
  }, 2000);
}
