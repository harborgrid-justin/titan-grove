...
function handlefleettrackingAction() {
    ...
    window.geospatialPages.showNotification('Fleet & Vehicle Tracking configured successfully', 'success');
}
...
function executefleettracking() {
    ...
    setTimeout(() => {
        window.geospatialPages.showNotification('Fleet & Vehicle Tracking operation completed successfully', 'success');
    }, 2000);
}
