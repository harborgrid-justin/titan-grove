...
function handlemobileworkforceAction() {
  ...
  window.geospatialPages.showNotification(
    'Mobile Workforce Management configured successfully',
    'success'
  );
}
...
function executemobileworkforce() {
  ...
  window.geospatialPages.showNotification(
    'Mobile Workforce Management operation initiated',
    'info'
  );
  ...
  setTimeout(() => {
    window.geospatialPages.showNotification(
      'Mobile Workforce Management operation completed successfully',
      'success'
    );
  }, 2000);
}
