...
function handlegeofencingalertsAction() {
    ...
    window.geospatialPages.showNotification('Geofencing & Spatial Alerts configured successfully', 'success');
}

function executegeofencingalerts() {
    console.log('Geofencing & Spatial Alerts execution started');
    window.geospatialPages.showNotification('Geofencing & Spatial Alerts operation initiated', 'info');
    
    // Simulate geospatial API call
    setTimeout(() => {
        window.geospatialPages.showNotification('Geofencing & Spatial Alerts operation completed successfully', 'success');
    }, 2000);
}
