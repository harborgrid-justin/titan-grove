...
function handlespatialstatisticsAction() {
  ...
  window.geospatialPages.showNotification(
    'Spatial Statistics & Analysis configured successfully',
    'success'
  );
}
...
function executespatialstatistics() {
  ...
  window.geospatialPages.showNotification(
    'Spatial Statistics & Analysis operation initiated',
    'info'
  );
  ...
  setTimeout(() => {
    window.geospatialPages.showNotification(
      'Spatial Statistics & Analysis operation completed successfully',
      'success'
    );
  }, 2000);
}
