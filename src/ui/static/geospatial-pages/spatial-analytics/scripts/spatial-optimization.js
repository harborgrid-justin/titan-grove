...
function handlespatialoptimizationAction() {
  ...
  window.geospatialPages.showNotification(
    'Spatial Optimization Engine configured successfully',
    'success'
  );
}
...
function executespatialoptimization() {
  ...
  window.geospatialPages.showNotification(
    'Spatial Optimization Engine operation initiated',
    'info'
  );
  ...
  setTimeout(() => {
    window.geospatialPages.showNotification(
      'Spatial Optimization Engine operation completed successfully',
      'success'
    );
  }, 2000);
}
