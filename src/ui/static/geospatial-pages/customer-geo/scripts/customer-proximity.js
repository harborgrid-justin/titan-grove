...
function handlecustomerproximityAction() {
  ...
  window.geospatialPages.showNotification(
    'Customer Proximity Services configured successfully',
    'success'
  );
}
...
function executecustomerproximity() {
  ...
  window.geospatialPages.showNotification(
    'Customer Proximity Services operation initiated',
    'info'
  );
  ...
  setTimeout(() => {
    window.geospatialPages.showNotification(
      'Customer Proximity Services operation completed successfully',
      'success'
    );
  }, 2000);
}
