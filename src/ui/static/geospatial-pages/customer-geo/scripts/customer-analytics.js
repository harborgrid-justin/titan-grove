...
function handlecustomeranalyticsAction() {
  ...
  window.geospatialPages.showNotification(
    'Customer Location Analytics configured successfully',
    'success'
  );
}
...
function executecustomeranalytics() {
  ...
  window.geospatialPages.showNotification(
    'Customer Location Analytics operation initiated',
    'info'
  );
  ...
  setTimeout(() => {
    window.geospatialPages.showNotification(
      'Customer Location Analytics operation completed successfully',
      'success'
    );
  }, 2000);
}
