...
function handleterritorymanagementAction() {
    ...
    window.geospatialPages.showNotification('Sales Territory Management configured successfully', 'success');
}
...
function executeterritorymanagement() {
    ...
    setTimeout(() => {
        window.geospatialPages.showNotification('Sales Territory Management operation completed successfully', 'success');
    }, 2000);
}
