...
function handlesiteselectionAction() {
    ...
    window.geospatialPages.showNotification('Retail Site Selection configured successfully', 'success');
}
...
function executesiteselection() {
    ...
    setTimeout(() => {
        window.geospatialPages.showNotification('Retail Site Selection operation completed successfully', 'success');
    }, 2000);
}
