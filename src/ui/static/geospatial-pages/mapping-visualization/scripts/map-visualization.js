...
function handlemapvisualizationAction() {
    ...
    window.geospatialPages.showNotification('Advanced Map Visualization configured successfully', 'success');
}
...
function executemapvisualization() {
    ...
    setTimeout(() => {
        window.geospatialPages.showNotification('Advanced Map Visualization operation completed successfully', 'success');
    }, 2000);
}
