...
function handlelocationsearchAction() {
    ...
    window.geospatialPages.showNotification('Advanced Location Search configured successfully', 'success');
}
...
function executelocationsearch() {
    ...
    setTimeout(() => {
        window.geospatialPages.showNotification('Advanced Location Search operation completed successfully', 'success');
    }, 2000);
}
