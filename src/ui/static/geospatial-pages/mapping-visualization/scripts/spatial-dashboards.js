...
function handlespatialdashboardsAction() {
  ...
  window.geospatialPages.showNotification(
    'Geospatial Dashboard Analytics configured successfully',
    'success'
  );
}
...
function executespatialdashboards() {
  ...
  window.geospatialPages.showNotification(
    'Geospatial Dashboard Analytics operation initiated',
    'info'
  );
  ...
  setTimeout(() => {
    window.geospatialPages.showNotification(
      'Geospatial Dashboard Analytics operation completed successfully',
      'success'
    );
  }, 2000);
}
