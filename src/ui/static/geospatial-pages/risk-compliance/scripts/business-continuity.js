...
function handlebusinesscontinuityAction() {
  ...
  window.geospatialPages.showNotification(
    'Business Continuity Planning configured successfully',
    'success'
  );
}
...
function executebusinesscontinuity() {
  ...
  window.geospatialPages.showNotification(
    'Business Continuity Planning operation initiated',
    'info'
  );
  ...
  setTimeout(() => {
    window.geospatialPages.showNotification(
      'Business Continuity Planning operation completed successfully',
      'success'
    );
  }, 2000);
}
