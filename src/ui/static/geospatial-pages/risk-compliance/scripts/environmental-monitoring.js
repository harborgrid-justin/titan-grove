...
function handleenvironmentalmonitoringAction() {
  ...
  window.geospatialPages.showNotification(
    'Environmental Risk Monitoring configured successfully',
    'success'
  );
}
...
function executeenvironmentalmonitoring() {
  ...
  window.geospatialPages.showNotification(
    'Environmental Risk Monitoring operation initiated',
    'info'
  );
  ...
  setTimeout(() => {
    window.geospatialPages.showNotification(
      'Environmental Risk Monitoring operation completed successfully',
      'success'
    );
  }, 2000);
}
