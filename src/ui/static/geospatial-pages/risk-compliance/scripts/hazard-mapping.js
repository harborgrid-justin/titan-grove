...
function handlehazardmappingAction() {
    ...
    window.geospatialPages.showNotification('Natural Hazard Mapping configured successfully', 'success');
}
...
function executehazardmapping() {
    ...
    setTimeout(() => {
        window.geospatialPages.showNotification('Natural Hazard Mapping operation completed successfully', 'success');
    }, 2000);
}
