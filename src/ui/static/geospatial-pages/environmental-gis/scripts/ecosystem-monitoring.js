...
function handleecosystemmonitoringAction() {
    ...
    window.geospatialPages.showNotification('Ecosystem Health Monitoring configured successfully', 'success');
}

function executeecosystemmonitoring() {
    console.log('Ecosystem Health Monitoring execution started');
    window.geospatialPages.showNotification('Ecosystem Health Monitoring operation initiated', 'info');
    
    // Simulate geospatial API call
    setTimeout(() => {
        window.geospatialPages.showNotification('Ecosystem Health Monitoring operation completed successfully', 'success');
    }, 2000);
}
