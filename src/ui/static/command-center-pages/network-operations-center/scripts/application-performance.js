...
function handleapplicationPerformanceAction() {
    ...
    if (actionBtn) {
        ...
        setTimeout(() => {
            ...
            window.commandCenterPages.showNotification('Application Performance Monitoring action completed successfully', 'success');
        }, 2000);
    }
}
...
function loadapplicationPerformanceData() {
    ...
    if (window.commandCenterPages) {
        window.commandCenterPages.loadPageData('application-performance').then(data => {
