...
function handleserviceAvailabilityAction() {
    ...
    if (actionBtn) {
        ...
        setTimeout(() => {
            ...
            window.commandCenterPages.showNotification('Service Availability Management action completed successfully', 'success');
        }, 2000);
    }
}
...
function loadserviceAvailabilityData() {
    ...
    if (window.commandCenterPages) {
        window.commandCenterPages.loadPageData('service-availability').then(data => {
