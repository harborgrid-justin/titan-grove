...
function handleinfrastructureManagementAction() {
    ...
    if (actionBtn) {
        ...
        setTimeout(() => {
            ...
            window.commandCenterPages.showNotification('IT Infrastructure Management action completed successfully', 'success');
        }, 2000);
    }
}
...
function loadinfrastructureManagementData() {
    ...
    if (window.commandCenterPages) {
        window.commandCenterPages.loadPageData('infrastructure-management').then(data => {
