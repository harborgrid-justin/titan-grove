...
function handleexecutiveIntelligenceAction() {
    ...
    if (actionBtn) {
        ...
        setTimeout(() => {
            ...
            window.commandCenterPages.showNotification('Executive Intelligence Center action completed successfully', 'success');
        }, 2000);
    }
}
...
function loadexecutiveIntelligenceData() {
    ...
    if (window.commandCenterPages) {
        window.commandCenterPages.loadPageData('executive-intelligence').then(data => {
