...
function handlewarehouseOperationsAction() {
    ...
    if (actionBtn) {
        ...
        setTimeout(() => {
            ...
            window.commandCenterPages.showNotification('Warehouse Operations Control action completed successfully', 'success');
        }, 2000);
    }
}
...
function loadwarehouseOperationsData() {
    ...
    if (window.commandCenterPages) {
        window.commandCenterPages.loadPageData('warehouse-operations').then(data => {
