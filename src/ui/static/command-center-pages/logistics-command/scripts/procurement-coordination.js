...
function handleprocurementCoordinationAction() {
    ...
    if (actionBtn) {
        ...
        setTimeout(() => {
            ...
            window.commandCenterPages.showNotification('Procurement Coordination Hub action completed successfully', 'success');
        }, 2000);
    }
}
...
function loadprocurementCoordinationData() {
    ...
    if (window.commandCenterPages) {
        window.commandCenterPages.loadPageData('procurement-coordination').then(data => {
