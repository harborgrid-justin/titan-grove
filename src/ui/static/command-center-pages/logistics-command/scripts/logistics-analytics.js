...
function handlelogisticsAnalyticsAction() {
    ...
    if (actionBtn) {
        ...
        setTimeout(() => {
            ...
            window.commandCenterPages.showNotification('Logistics Analytics & Intelligence action completed successfully', 'success');
        }, 2000);
    }
}
...
function loadlogisticsAnalyticsData() {
    ...
    if (window.commandCenterPages) {
        window.commandCenterPages.loadPageData('logistics-analytics').then(data => {
