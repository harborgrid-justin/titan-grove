...
function handledistributionManagementAction() {
    ...
    if (actionBtn) {
        ...
        setTimeout(() => {
            ...
            window.commandCenterPages.showNotification('Distribution Management Center action completed successfully', 'success');
        }, 2000);
    }
}
...
function loaddistributionManagementData() {
    ...
    if (window.commandCenterPages) {
        window.commandCenterPages.loadPageData('distribution-management').then(data => {
