...
function handleoperationalIntelligenceAction() {
    ...
    if (actionBtn) {
        ...
        setTimeout(() => {
            ...
            window.commandCenterPages.showNotification('Operational Intelligence Hub action completed successfully', 'success');
        }, 2000);
    }
}
...
function loadoperationalIntelligenceData() {
    ...
    if (window.commandCenterPages) {
        window.commandCenterPages.loadPageData('operational-intelligence').then(data => {
