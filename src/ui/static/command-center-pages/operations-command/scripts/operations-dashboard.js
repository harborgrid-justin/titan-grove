...
function handleoperationsDashboardAction() {
    ...
    if (actionBtn) {
        ...
        setTimeout(() => {
            ...
            window.commandCenterPages.showNotification('Central Operations Dashboard action completed successfully', 'success');
        }, 2000);
    }
}
...
function loadoperationsDashboardData() {
    ...
    if (window.commandCenterPages) {
        window.commandCenterPages.loadPageData('operations-dashboard').then(data => {
