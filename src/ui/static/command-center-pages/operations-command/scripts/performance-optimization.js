...
function handleperformanceOptimizationAction() {
    ...
    if (actionBtn) {
        ...
        setTimeout(() => {
            ...
            window.commandCenterPages.showNotification('Performance Optimization Center action completed successfully', 'success');
        }, 2000);
    }
}
...
function loadperformanceOptimizationData() {
    ...
    if (window.commandCenterPages) {
        window.commandCenterPages.loadPageData('performance-optimization').then(data => {
