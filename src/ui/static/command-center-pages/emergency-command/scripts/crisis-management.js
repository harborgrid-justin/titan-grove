...
function handlecrisisManagementAction() {
    ...
    if (actionBtn) {
        ...
        setTimeout(() => {
            ...
            window.commandCenterPages.showNotification('Crisis Management Center action completed successfully', 'success');
        }, 2000);
    }
}
...
function loadcrisisManagementData() {
    ...
    if (window.commandCenterPages) {
        window.commandCenterPages.loadPageData('crisis-management').then(data => {
