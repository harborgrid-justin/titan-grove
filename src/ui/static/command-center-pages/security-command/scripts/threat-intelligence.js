...
function handlethreatIntelligenceAction() {
    ...
    if (actionBtn) {
        ...
        setTimeout(() => {
            ...
            window.commandCenterPages.showNotification('Threat Intelligence Platform action completed successfully', 'success');
        }, 2000);
    }
}
...
function loadthreatIntelligenceData() {
    ...
    if (window.commandCenterPages) {
        window.commandCenterPages.loadPageData('threat-intelligence').then(data => {
