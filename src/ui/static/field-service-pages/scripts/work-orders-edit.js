...
class WorkOrderEditManager {
    ...
    initializeEventListeners() {
        ...
        document.getElementById('workOrderStatus')?.addEventListener('change', (e) => this.updateStatus(e.target.value));
        document.getElementById('assignedTech')?.addEventListener('change', (e) => this.reassignTechnician(e.target.value));
        document.getElementById('priorityLevel')?.addEventListener('change', (e) => this.updatePriority(e.target.value));
        ...
        document.getElementById('duplicateWorkOrder')?.addEventListener('click', () => this.duplicateWorkOrder());
