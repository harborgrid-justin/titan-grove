...
class WorkOrderCreateManager {
  ...
  initializeEventListeners() {
    ...
    document
      ...
      ?.addEventListener('change', (e) => this.loadCustomerDetails(e.target.value));

    // Service type change
    document
      .getElementById('serviceType')
      ?.addEventListener('change', (e) => this.updateEstimatedDuration(e.target.value));

    // Auto-assignment based on skills and location
    document
      .getElementById('skillsRequired')
      ?.addEventListener('blur', () => this.suggestTechnicians());
    document
    ...
    document
      ...
      ?.addEventListener('change', (e) => this.handlePriorityChange(e.target.value));
  }
  ...
  handlePriorityChange(priority) {
    if (priority === 'critical') {
      this.showWarningMessage(
        'Critical priority work orders will trigger immediate notifications to supervisors'
      );
    }
  }
