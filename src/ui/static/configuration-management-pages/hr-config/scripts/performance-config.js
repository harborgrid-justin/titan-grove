...
class PerformanceConfigManager extends ConfigurationManager {
    ...
    loadModuleSpecificConfig() {
        ...
        this.moduleConfig = {
            endpoints: {
                validate: `/api/v1/config/hr/performance-config/validate`,
                deploy: `/api/v1/config/hr/performance-config/deploy`,
                rollback: `/api/v1/config/hr/performance-config/rollback`,
                history: `/api/v1/config/hr/performance-config/history`
            },
            features: {
                autoValidation: true,
                realTimeSync: true,
