...
async function loaddatabaseservermanagementData() {
    try {
        const response = await fetch('/api/database/database-administration/database-server-management');
        if (response.ok) {
...
function setupPageActions() {
    ...
    if (testBtn) {
        testBtn.addEventListener('click', async function() {
            try {
                const response = await fetch('/api/database/database-administration/database-server-management/test');
    ...
    if (exportBtn) {
        exportBtn.addEventListener('click', async function() {
            try {
                const response = await fetch('/api/database/database-administration/database-server-management/export');
