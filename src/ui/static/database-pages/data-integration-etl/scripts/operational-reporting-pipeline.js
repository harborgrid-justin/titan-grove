...
async function loadOperationalReportingPipelineData() {
    try {
        const response = await fetch('/api/database/data-integration-etl/operational-reporting-pipeline');
        if (response.ok) {
...
function setupPageActions() {
    ...
    if (testBtn) {
        testBtn.addEventListener('click', async function() {
            try {
                const response = await fetch('/api/database/data-integration-etl/operational-reporting-pipeline/test');
    ...
    if (exportBtn) {
        exportBtn.addEventListener('click', async function() {
            try {
                const response = await fetch('/api/database/data-integration-etl/operational-reporting-pipeline/export');
