...
async function loadEnterpriseDataWarehouseManagementData() {
    try {
        const response = await fetch('/api/database/data-integration-etl/enterprise-data-warehouse-management');
        if (response.ok) {
...
function setupPageActions() {
    ...
    if (testBtn) {
        testBtn.addEventListener('click', async function() {
            try {
                const response = await fetch('/api/database/data-integration-etl/enterprise-data-warehouse-management/test');
    ...
    if (exportBtn) {
        exportBtn.addEventListener('click', async function() {
            try {
                const response = await fetch('/api/database/data-integration-etl/enterprise-data-warehouse-management/export');
