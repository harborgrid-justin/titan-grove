...
async function loadPerformanceOptimizationEngineData() {
  try {
    const response = await fetch(
      '/api/database/data-integration-etl/performance-optimization-engine'
    );
    if (response.ok) {
...
function setupPageActions() {
  ...
  if (testBtn) {
    testBtn.addEventListener('click', async function () {
      try {
        const response = await fetch(
          '/api/database/data-integration-etl/performance-optimization-engine/test'
        );
  ...
  if (exportBtn) {
    exportBtn.addEventListener('click', async function () {
      try {
        const response = await fetch(
          '/api/database/data-integration-etl/performance-optimization-engine/export'
        );
