...
class ChangeRiskAssessmentManager {
  ...
  async loadData() {
    try {
      const response = await window.SupportPageManager.apiRequest(
        '/api/v1/support/change-management/change-risk-assessment'
      );
  ...
  async testIntegration() {
    try {
      window.SupportPageManager.showNotification(
        'Testing Change Risk Assessment integration...',
        'info'
      );

      const tests = [
        {
          name: 'Change Risk Assessment API',
          endpoint: '/api/v1/support/change-management/change-risk-assessment',
        },
        { name: 'Config API', endpoint: '/api/v1/support/change-management/config' },
        {
          name: 'Analytics API',
          endpoint: '/api/v1/support/change-management/change-risk-assessment/analytics',
        },
      ];
  ...
  async createRecord() {
    try {
      window.SupportPageManager.showNotification(
        'Creating new change risk assessment record...',
        'info'
      );
  ...
  async importData() {
    try {
      window.SupportPageManager.showNotification(
        'Importing change risk assessment data...',
        'info'
      );
  ...
  async viewAnalytics() {
    try {
      window.SupportPageManager.showNotification(
        'Loading change risk assessment analytics...',
        'info'
      );
  ...
  async exportReport() {
    try {
      window.SupportPageManager.showNotification(
        'Generating change risk assessment report...',
        'info'
      );
  ...
  async exportData() {
    try {
      window.SupportPageManager.showNotification(
        'Exporting change risk assessment data...',
        'info'
      );
