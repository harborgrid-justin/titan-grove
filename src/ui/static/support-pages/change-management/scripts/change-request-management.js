...
class ChangeRequestManagementManager {
  ...
  async loadData() {
    try {
      const response = await window.SupportPageManager.apiRequest(
        '/api/v1/support/change-management/change-request-management'
      );
  ...
  async testIntegration() {
    try {
      window.SupportPageManager.showNotification(
        'Testing Change Request Management integration...',
        'info'
      );

      const tests = [
        {
          name: 'Change Request Management API',
          endpoint: '/api/v1/support/change-management/change-request-management',
        },
        { name: 'Config API', endpoint: '/api/v1/support/change-management/config' },
        {
          name: 'Analytics API',
          endpoint: '/api/v1/support/change-management/change-request-management/analytics',
        },
      ];
  ...
  async createRecord() {
    try {
      window.SupportPageManager.showNotification(
        'Creating new change request management record...',
        'info'
      );
  ...
  async importData() {
    try {
      window.SupportPageManager.showNotification(
        'Importing change request management data...',
        'info'
      );
  ...
  async viewAnalytics() {
    try {
      window.SupportPageManager.showNotification(
        'Loading change request management analytics...',
        'info'
      );
  ...
  async exportReport() {
    try {
      window.SupportPageManager.showNotification(
        'Generating change request management report...',
        'info'
      );
  ...
  async exportData() {
    try {
      window.SupportPageManager.showNotification(
        'Exporting change request management data...',
        'info'
      );
