...
class EmergencyChangesManager {
  ...
  async loadData() {
    try {
      const response = await window.SupportPageManager.apiRequest(
        '/api/v1/support/change-management/emergency-changes'
      );
  ...
  async testIntegration() {
    try {
      window.SupportPageManager.showNotification(
        'Testing Emergency Changes integration...',
        'info'
      );

      const tests = [
        {
          name: 'Emergency Changes API',
          endpoint: '/api/v1/support/change-management/emergency-changes',
        },
        { name: 'Config API', endpoint: '/api/v1/support/change-management/config' },
        {
          name: 'Analytics API',
          endpoint: '/api/v1/support/change-management/emergency-changes/analytics',
        },
      ];
  ...
  async createRecord() {
    try {
      window.SupportPageManager.showNotification(
        'Creating new emergency changes record...',
        'info'
      );
