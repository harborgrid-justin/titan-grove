...
class ChangeAdvisoryBoardManager {
  ...
  async loadData() {
    try {
      const response = await window.SupportPageManager.apiRequest(
        '/api/v1/support/change-management/change-advisory-board'
      );
  ...
  async testIntegration() {
    try {
      window.SupportPageManager.showNotification(
        'Testing Change Advisory Board integration...',
        'info'
      );

      const tests = [
        {
          name: 'Change Advisory Board API',
          endpoint: '/api/v1/support/change-management/change-advisory-board',
        },
        { name: 'Config API', endpoint: '/api/v1/support/change-management/config' },
        {
          name: 'Analytics API',
          endpoint: '/api/v1/support/change-management/change-advisory-board/analytics',
        },
      ];
  ...
  async createRecord() {
    try {
      window.SupportPageManager.showNotification(
        'Creating new change advisory board record...',
        'info'
      );
  ...
  async viewAnalytics() {
    try {
      window.SupportPageManager.showNotification(
        'Loading change advisory board analytics...',
        'info'
      );
  ...
  async exportReport() {
    try {
      window.SupportPageManager.showNotification(
        'Generating change advisory board report...',
        'info'
      );
