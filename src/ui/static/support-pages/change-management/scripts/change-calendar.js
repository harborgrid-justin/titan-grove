...
class ChangeCalendarManager {
  ...
  async loadData() {
    try {
      const response = await window.SupportPageManager.apiRequest(
        '/api/v1/support/change-management/change-calendar'
      );
  ...
  async testIntegration() {
    try {
      ...
      const tests = [
        {
          name: 'Change Calendar API',
          endpoint: '/api/v1/support/change-management/change-calendar',
        },
        { name: 'Config API', endpoint: '/api/v1/support/change-management/config' },
        {
          name: 'Analytics API',
          endpoint: '/api/v1/support/change-management/change-calendar/analytics',
        },
      ];
