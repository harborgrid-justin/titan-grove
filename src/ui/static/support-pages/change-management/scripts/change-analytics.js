...
class ChangeAnalyticsManager {
  ...
  async loadConfiguration() {
    try {
      const response = await window.SupportPageManager.apiRequest(
        '/api/v1/support/change-management/config'
      );
  ...
  async loadData() {
    try {
      const response = await window.SupportPageManager.apiRequest(
        '/api/v1/support/change-management/change-analytics'
      );
  ...
  async testIntegration() {
    try {
      ...
      const tests = [
        {
          name: 'Change Analytics API',
          endpoint: '/api/v1/support/change-management/change-analytics',
        },
        { name: 'Config API', endpoint: '/api/v1/support/change-management/config' },
        {
          name: 'Analytics API',
          endpoint: '/api/v1/support/change-management/change-analytics/analytics',
        },
      ];
