...
class KnowledgeAnalyticsManager {
  ...
  async loadData() {
    try {
      const response = await window.SupportPageManager.apiRequest(
        '/api/v1/support/knowledge-management/knowledge-analytics'
      );
  ...
  async testIntegration() {
    try {
      window.SupportPageManager.showNotification(
        'Testing Knowledge Analytics integration...',
        'info'
      );

      const tests = [
        {
          name: 'Knowledge Analytics API',
          endpoint: '/api/v1/support/knowledge-management/knowledge-analytics',
        },
        { name: 'Config API', endpoint: '/api/v1/support/knowledge-management/config' },
        {
          name: 'Analytics API',
          endpoint: '/api/v1/support/knowledge-management/knowledge-analytics/analytics',
        },
      ];
  ...
  async createRecord() {
    try {
      window.SupportPageManager.showNotification(
        'Creating new knowledge analytics record...',
        'info'
      );
  ...
  async viewAnalytics() {
    try {
      window.SupportPageManager.showNotification(
        'Loading knowledge analytics analytics...',
        'info'
      );
  ...
  async exportReport() {
    try {
      window.SupportPageManager.showNotification(
        'Generating knowledge analytics report...',
        'info'
      );
