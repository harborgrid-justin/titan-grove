...
class KnowledgeSearchManager {
  ...
  async loadData() {
    try {
      const response = await window.SupportPageManager.apiRequest(
        '/api/v1/support/knowledge-management/knowledge-search'
      );
      ...
      const tests = [
        {
          ...
          endpoint: '/api/v1/support/knowledge-management/knowledge-search',
        },
        { name: 'Config API', endpoint: '/api/v1/support/knowledge-management/config' },
        {
          name: 'Analytics API',
          endpoint: '/api/v1/support/knowledge-management/knowledge-search/analytics',
        },
      ];
