...
class ContentLifecycleManager {
  ...
  async loadData() {
    try {
      const response = await window.SupportPageManager.apiRequest(
        '/api/v1/support/knowledge-management/content-lifecycle'
      );
  ...
  async testIntegration() {
    try {
      window.SupportPageManager.showNotification(
        'Testing Content Lifecycle integration...',
        'info'
      );

      const tests = [
        {
          name: 'Content Lifecycle API',
          endpoint: '/api/v1/support/knowledge-management/content-lifecycle',
        },
        { name: 'Config API', endpoint: '/api/v1/support/knowledge-management/config' },
        {
          name: 'Analytics API',
          endpoint: '/api/v1/support/knowledge-management/content-lifecycle/analytics',
        },
      ];
  ...
  async createRecord() {
    try {
      window.SupportPageManager.showNotification(
        'Creating new content lifecycle record...',
        'info'
      );
