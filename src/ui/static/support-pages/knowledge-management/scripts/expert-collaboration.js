...
class ExpertCollaborationManager {
  ...
  async loadData() {
    try {
      const response = await window.SupportPageManager.apiRequest(
        '/api/v1/support/knowledge-management/expert-collaboration'
      );
  ...
  async testIntegration() {
    try {
      window.SupportPageManager.showNotification(
        'Testing Expert Collaboration integration...',
        'info'
      );

      const tests = [
        {
          name: 'Expert Collaboration API',
          endpoint: '/api/v1/support/knowledge-management/expert-collaboration',
        },
        { name: 'Config API', endpoint: '/api/v1/support/knowledge-management/config' },
        {
          name: 'Analytics API',
          endpoint: '/api/v1/support/knowledge-management/expert-collaboration/analytics',
        },
      ];
  ...
  async createRecord() {
    try {
      window.SupportPageManager.showNotification(
        'Creating new expert collaboration record...',
        'info'
      );
  ...
  async viewAnalytics() {
    try {
      window.SupportPageManager.showNotification(
        'Loading expert collaboration analytics...',
        'info'
      );
  ...
  async exportReport() {
    try {
      window.SupportPageManager.showNotification(
        'Generating expert collaboration report...',
        'info'
      );
