...
class RootCauseAnalysisManager {
  ...
  async loadData() {
    try {
      const response = await window.SupportPageManager.apiRequest(
        '/api/v1/support/problem-management/root-cause-analysis'
      );
  ...
  async testIntegration() {
    try {
      window.SupportPageManager.showNotification(
        'Testing Root Cause Analysis integration...',
        'info'
      );
      ...
      const tests = [
        {
          ...
          endpoint: '/api/v1/support/problem-management/root-cause-analysis',
        },
        { name: 'Config API', endpoint: '/api/v1/support/problem-management/config' },
        {
          name: 'Analytics API',
          endpoint: '/api/v1/support/problem-management/root-cause-analysis/analytics',
        },
      ];
  ...
  async createRecord() {
    try {
      window.SupportPageManager.showNotification(
        'Creating new root cause analysis record...',
        'info'
      );
  ...
  async viewAnalytics() {
    try {
      window.SupportPageManager.showNotification(
        'Loading root cause analysis analytics...',
        'info'
      );
