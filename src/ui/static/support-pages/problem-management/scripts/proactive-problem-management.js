...
class ProactiveProblemManagementManager {
  ...
  async loadConfiguration() {
    try {
      const response = await window.SupportPageManager.apiRequest(
        '/api/v1/support/problem-management/config'
      );
  ...
  async loadData() {
    try {
      const response = await window.SupportPageManager.apiRequest(
        '/api/v1/support/problem-management/proactive-problem-management'
      );
  ...
  async testIntegration() {
    try {
      window.SupportPageManager.showNotification(
        'Testing Proactive Problem Management integration...',
        'info'
      );

      const tests = [
        {
          name: 'Proactive Problem Management API',
          endpoint: '/api/v1/support/problem-management/proactive-problem-management',
        },
        { name: 'Config API', endpoint: '/api/v1/support/problem-management/config' },
        {
          name: 'Analytics API',
          endpoint: '/api/v1/support/problem-management/proactive-problem-management/analytics',
        },
      ];
  ...
  async createRecord() {
    try {
      window.SupportPageManager.showNotification(
        'Creating new proactive problem management record...',
        'info'
      );
  ...
  async importData() {
    try {
      window.SupportPageManager.showNotification(
        'Importing proactive problem management data...',
        'info'
      );
  ...
  async viewAnalytics() {
    try {
      window.SupportPageManager.showNotification(
        'Loading proactive problem management analytics...',
        'info'
      );
  ...
  async exportReport() {
    try {
      window.SupportPageManager.showNotification(
        'Generating proactive problem management report...',
        'info'
      );
  ...
  async exportData() {
    try {
      window.SupportPageManager.showNotification(
        'Exporting proactive problem management data...',
        'info'
      );
