...
class ProblemAnalyticsManager {
  ...
  async loadData() {
    try {
      const response = await window.SupportPageManager.apiRequest(
        '/api/v1/support/problem-management/problem-analytics'
      );
  ...
  async testIntegration() {
    try {
      window.SupportPageManager.showNotification(
        'Testing Problem Analytics integration...',
        'info'
      );

      const tests = [
        {
          name: 'Problem Analytics API',
          endpoint: '/api/v1/support/problem-management/problem-analytics',
        },
        { name: 'Config API', endpoint: '/api/v1/support/problem-management/config' },
        {
          name: 'Analytics API',
          endpoint: '/api/v1/support/problem-management/problem-analytics/analytics',
        },
      ];
  ...
  async createRecord() {
    try {
      window.SupportPageManager.showNotification(
        'Creating new problem analytics record...',
        'info'
      );
