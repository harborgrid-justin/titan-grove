...
class ProblemIdentificationManager {
  ...
  async loadData() {
    try {
      const response = await window.SupportPageManager.apiRequest(
        '/api/v1/support/problem-management/problem-identification'
      );
  ...
  async testIntegration() {
    try {
      window.SupportPageManager.showNotification(
        'Testing Problem Identification integration...',
        'info'
      );

      const tests = [
        {
          name: 'Problem Identification API',
          endpoint: '/api/v1/support/problem-management/problem-identification',
        },
        { name: 'Config API', endpoint: '/api/v1/support/problem-management/config' },
        {
          name: 'Analytics API',
          endpoint: '/api/v1/support/problem-management/problem-identification/analytics',
        },
      ];
  ...
  async createRecord() {
    try {
      window.SupportPageManager.showNotification(
        'Creating new problem identification record...',
        'info'
      );
  ...
  async importData() {
    try {
      window.SupportPageManager.showNotification(
        'Importing problem identification data...',
        'info'
      );
  ...
  async viewAnalytics() {
    try {
      window.SupportPageManager.showNotification(
        'Loading problem identification analytics...',
        'info'
      );
  ...
  async exportReport() {
    try {
      window.SupportPageManager.showNotification(
        'Generating problem identification report...',
        'info'
      );
  ...
  async exportData() {
    try {
      window.SupportPageManager.showNotification(
        'Exporting problem identification data...',
        'info'
      );
