...
class ProblemPrioritizationManager {
  ...
  async loadData() {
    try {
      const response = await window.SupportPageManager.apiRequest(
        '/api/v1/support/problem-management/problem-prioritization'
      );
  ...
  async testIntegration() {
    try {
      window.SupportPageManager.showNotification(
        'Testing Problem Prioritization integration...',
        'info'
      );

      const tests = [
        {
          name: 'Problem Prioritization API',
          endpoint: '/api/v1/support/problem-management/problem-prioritization',
        },
        { name: 'Config API', endpoint: '/api/v1/support/problem-management/config' },
        {
          name: 'Analytics API',
          endpoint: '/api/v1/support/problem-management/problem-prioritization/analytics',
        },
      ];
  ...
  async createRecord() {
    try {
      window.SupportPageManager.showNotification(
        'Creating new problem prioritization record...',
        'info'
      );
  ...
  async importData() {
    try {
      window.SupportPageManager.showNotification(
        'Importing problem prioritization data...',
        'info'
      );
  ...
  async viewAnalytics() {
    try {
      window.SupportPageManager.showNotification(
        'Loading problem prioritization analytics...',
        'info'
      );
  ...
  async exportReport() {
    try {
      window.SupportPageManager.showNotification(
        'Generating problem prioritization report...',
        'info'
      );
  ...
  async exportData() {
    try {
      window.SupportPageManager.showNotification(
        'Exporting problem prioritization data...',
        'info'
      );
