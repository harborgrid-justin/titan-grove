...
class SlaDefinitionManager {
  ...
  async loadData() {
    try {
      const response = await window.SupportPageManager.apiRequest(
        '/api/v1/support/service-level-management/sla-definition'
      );
  ...
  async testIntegration() {
    try {
      ...
      const tests = [
        {
          name: 'SLA Definition API',
          endpoint: '/api/v1/support/service-level-management/sla-definition',
        },
        { name: 'Config API', endpoint: '/api/v1/support/service-level-management/config' },
        {
          name: 'Analytics API',
          endpoint: '/api/v1/support/service-level-management/sla-definition/analytics',
        },
      ];
