...
class SlaMonitoringManager {
  ...
  async loadData() {
    try {
      const response = await window.SupportPageManager.apiRequest(
        '/api/v1/support/service-level-management/sla-monitoring'
      );
  ...
  async testIntegration() {
    try {
      ...
      const tests = [
        {
          name: 'SLA Monitoring API',
          endpoint: '/api/v1/support/service-level-management/sla-monitoring',
        },
        { name: 'Config API', endpoint: '/api/v1/support/service-level-management/config' },
        {
          name: 'Analytics API',
          endpoint: '/api/v1/support/service-level-management/sla-monitoring/analytics',
        },
      ];
