...
class PerformanceAnalyticsManager {
    ...
    async loadData() {
        try {
            const response = await window.SupportPageManager.apiRequest('/api/v1/support/service-level-management/performance-analytics');
    ...
    async testIntegration() {
        try {
            window.SupportPageManager.showNotification('Testing Performance Analytics integration...', 'info');
            
            const tests = [
                { name: 'Performance Analytics API', endpoint: '/api/v1/support/service-level-management/performance-analytics' },
                { name: 'Config API', endpoint: '/api/v1/support/service-level-management/config' },
                { name: 'Analytics API', endpoint: '/api/v1/support/service-level-management/performance-analytics/analytics' }
            ];
    ...
    async createRecord() {
        try {
            window.SupportPageManager.showNotification('Creating new performance analytics record...', 'info');
    ...
    async viewAnalytics() {
        try {
            window.SupportPageManager.showNotification('Loading performance analytics analytics...', 'info');
    ...
    async exportReport() {
        try {
            window.SupportPageManager.showNotification('Generating performance analytics report...', 'info');
