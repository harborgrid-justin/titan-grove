...
class ServiceCatalogManager {
  ...
  async loadData() {
    try {
      const response = await window.SupportPageManager.apiRequest(
        '/api/v1/support/service-level-management/service-catalog'
      );
      ...
      const tests = [
        {
          ...
          endpoint: '/api/v1/support/service-level-management/service-catalog',
        },
        { name: 'Config API', endpoint: '/api/v1/support/service-level-management/config' },
        {
          name: 'Analytics API',
          endpoint: '/api/v1/support/service-level-management/service-catalog/analytics',
        },
      ];
