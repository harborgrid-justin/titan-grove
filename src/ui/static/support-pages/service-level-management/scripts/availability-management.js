...
class AvailabilityManagementManager {
  ...
  async loadData() {
    try {
      const response = await window.SupportPageManager.apiRequest(
        '/api/v1/support/service-level-management/availability-management'
      );
  ...
  async testIntegration() {
    try {
      window.SupportPageManager.showNotification(
        'Testing Availability Management integration...',
        'info'
      );

      const tests = [
        {
          name: 'Availability Management API',
          endpoint: '/api/v1/support/service-level-management/availability-management',
        },
        { name: 'Config API', endpoint: '/api/v1/support/service-level-management/config' },
        {
          name: 'Analytics API',
          endpoint: '/api/v1/support/service-level-management/availability-management/analytics',
        },
      ];
  ...
  async createRecord() {
    try {
      window.SupportPageManager.showNotification(
        'Creating new availability management record...',
        'info'
      );
  ...
  async importData() {
    try {
      window.SupportPageManager.showNotification(
        'Importing availability management data...',
        'info'
      );
  ...
  async viewAnalytics() {
    try {
      window.SupportPageManager.showNotification(
        'Loading availability management analytics...',
        'info'
      );
  ...
  async exportReport() {
    try {
      window.SupportPageManager.showNotification(
        'Generating availability management report...',
        'info'
      );
  ...
  async exportData() {
    try {
      window.SupportPageManager.showNotification(
        'Exporting availability management data...',
        'info'
      );
