...
class SlaReportingManager {
  ...
  async loadData() {
    try {
      const response = await window.SupportPageManager.apiRequest(
        '/api/v1/support/service-level-management/sla-reporting'
      );
  ...
  async testIntegration() {
    try {
      ...
      const tests = [
        {
          name: 'SLA Reporting API',
          endpoint: '/api/v1/support/service-level-management/sla-reporting',
        },
        { name: 'Config API', endpoint: '/api/v1/support/service-level-management/config' },
        {
          name: 'Analytics API',
          endpoint: '/api/v1/support/service-level-management/sla-reporting/analytics',
        },
      ];
