...
class SupportAutomationManager {
  ...
  async loadData() {
    try {
      const response = await window.SupportPageManager.apiRequest(
        '/api/v1/support/support-operations/support-automation'
      );
  ...
  async testIntegration() {
    try {
      window.SupportPageManager.showNotification(
        'Testing Support Automation integration...',
        'info'
      );

      const tests = [
        {
          name: 'Support Automation API',
          endpoint: '/api/v1/support/support-operations/support-automation',
        },
        { name: 'Config API', endpoint: '/api/v1/support/support-operations/config' },
        {
          name: 'Analytics API',
          endpoint: '/api/v1/support/support-operations/support-automation/analytics',
        },
      ];
  ...
  async createRecord() {
    try {
      window.SupportPageManager.showNotification(
        'Creating new support automation record...',
        'info'
      );
