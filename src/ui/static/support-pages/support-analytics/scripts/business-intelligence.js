...
class BusinessIntelligenceManager {
  ...
  async loadData() {
    try {
      const response = await window.SupportPageManager.apiRequest(
        '/api/v1/support/support-analytics/business-intelligence'
      );
      ...
      const tests = [
        {
          ...
          endpoint: '/api/v1/support/support-analytics/business-intelligence',
        },
        { name: 'Config API', endpoint: '/api/v1/support/support-analytics/config' },
        {
          name: 'Analytics API',
          endpoint: '/api/v1/support/support-analytics/business-intelligence/analytics',
        },
      ];
  ...
  async createRecord() {
    try {
      window.SupportPageManager.showNotification(
        'Creating new business intelligence record...',
        'info'
      );
