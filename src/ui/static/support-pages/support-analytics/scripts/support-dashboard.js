...
class SupportDashboardManager {
  ...
  async loadData() {
    try {
      const response = await window.SupportPageManager.apiRequest(
        '/api/v1/support/support-analytics/support-dashboard'
      );
  ...
  async testIntegration() {
    try {
      window.SupportPageManager.showNotification(
        'Testing Support Dashboard integration...',
        'info'
      );
      ...
      const tests = [
        {
          ...
          endpoint: '/api/v1/support/support-analytics/support-dashboard',
        },
        { name: 'Config API', endpoint: '/api/v1/support/support-analytics/config' },
        {
          name: 'Analytics API',
          endpoint: '/api/v1/support/support-analytics/support-dashboard/analytics',
        },
      ];
  ...
  async createRecord() {
    try {
      window.SupportPageManager.showNotification(
        'Creating new support dashboard record...',
        'info'
      );
