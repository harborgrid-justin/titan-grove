...
class OperationalMetricsManager {
  ...
  async loadData() {
    try {
      const response = await window.SupportPageManager.apiRequest(
        '/api/v1/support/support-analytics/operational-metrics'
      );
  ...
  async testIntegration() {
    try {
      ...
      const tests = [
        {
          name: 'Operational Metrics API',
          endpoint: '/api/v1/support/support-analytics/operational-metrics',
        },
        { name: 'Config API', endpoint: '/api/v1/support/support-analytics/config' },
        {
          name: 'Analytics API',
          endpoint: '/api/v1/support/support-analytics/operational-metrics/analytics',
        },
      ];
  ...
  async createRecord() {
    try {
      window.SupportPageManager.showNotification(
        'Creating new operational metrics record...',
        'info'
      );
  ...
  async viewAnalytics() {
    try {
      window.SupportPageManager.showNotification(
        'Loading operational metrics analytics...',
        'info'
      );
  ...
  async exportReport() {
    try {
      window.SupportPageManager.showNotification(
        'Generating operational metrics report...',
        'info'
      );
