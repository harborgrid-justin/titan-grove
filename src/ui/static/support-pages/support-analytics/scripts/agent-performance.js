...
class AgentPerformanceManager {
  ...
  async loadData() {
    try {
      const response = await window.SupportPageManager.apiRequest(
        '/api/v1/support/support-analytics/agent-performance'
      );
      ...
      const tests = [
        {
          ...
          endpoint: '/api/v1/support/support-analytics/agent-performance',
        },
        { name: 'Config API', endpoint: '/api/v1/support/support-analytics/config' },
        {
          name: 'Analytics API',
          endpoint: '/api/v1/support/support-analytics/agent-performance/analytics',
        },
      ];
  ...
  async createRecord() {
    try {
      window.SupportPageManager.showNotification(
        'Creating new agent performance record...',
        'info'
      );
