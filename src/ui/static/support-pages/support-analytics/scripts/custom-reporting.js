...
class CustomReportingManager {
  ...
  async loadConfiguration() {
    try {
      const response = await window.SupportPageManager.apiRequest(
        '/api/v1/support/support-analytics/config'
      );
  ...
  async loadData() {
    try {
      const response = await window.SupportPageManager.apiRequest(
        '/api/v1/support/support-analytics/custom-reporting'
      );
      ...
      const tests = [
        {
          ...
          endpoint: '/api/v1/support/support-analytics/custom-reporting',
        },
        { name: 'Config API', endpoint: '/api/v1/support/support-analytics/config' },
        {
          name: 'Analytics API',
          endpoint: '/api/v1/support/support-analytics/custom-reporting/analytics',
        },
      ];
