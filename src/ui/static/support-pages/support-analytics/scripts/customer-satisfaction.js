...
class CustomerSatisfactionManager {
  ...
  async loadData() {
    try {
      const response = await window.SupportPageManager.apiRequest(
        '/api/v1/support/support-analytics/customer-satisfaction'
      );
  ...
  async testIntegration() {
    try {
      window.SupportPageManager.showNotification(
        'Testing Customer Satisfaction integration...',
        'info'
      );

      const tests = [
        {
          name: 'Customer Satisfaction API',
          endpoint: '/api/v1/support/support-analytics/customer-satisfaction',
        },
        { name: 'Config API', endpoint: '/api/v1/support/support-analytics/config' },
        {
          name: 'Analytics API',
          endpoint: '/api/v1/support/support-analytics/customer-satisfaction/analytics',
        },
      ];
  ...
  async createRecord() {
    try {
      window.SupportPageManager.showNotification(
        'Creating new customer satisfaction record...',
        'info'
      );
  ...
  async viewAnalytics() {
    try {
      window.SupportPageManager.showNotification(
        'Loading customer satisfaction analytics...',
        'info'
      );
