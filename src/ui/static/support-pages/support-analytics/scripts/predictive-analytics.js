...
class PredictiveAnalyticsManager {
  ...
  async loadData() {
    try {
      const response = await window.SupportPageManager.apiRequest(
        '/api/v1/support/support-analytics/predictive-analytics'
      );
      ...
      const tests = [
        {
          ...
          endpoint: '/api/v1/support/support-analytics/predictive-analytics',
        },
        { name: 'Config API', endpoint: '/api/v1/support/support-analytics/config' },
        {
          name: 'Analytics API',
          endpoint: '/api/v1/support/support-analytics/predictive-analytics/analytics',
        },
      ];
  ...
  async createRecord() {
    try {
      window.SupportPageManager.showNotification(
        'Creating new predictive analytics record...',
        'info'
      );
  ...
  async viewAnalytics() {
    try {
      window.SupportPageManager.showNotification(
        'Loading predictive analytics analytics...',
        'info'
      );
  ...
  async exportReport() {
    try {
      window.SupportPageManager.showNotification(
        'Generating predictive analytics report...',
        'info'
      );
