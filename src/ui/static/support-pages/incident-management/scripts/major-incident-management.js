...
class MajorIncidentManagementManager {
  ...
  async loadConfiguration() {
    try {
      const response = await window.SupportPageManager.apiRequest(
        '/api/v1/support/incident-management/config'
      );
  ...
  async loadData() {
    try {
      const response = await window.SupportPageManager.apiRequest(
        '/api/v1/support/incident-management/major-incident-management'
      );
  ...
  async testIntegration() {
    try {
      window.SupportPageManager.showNotification(
        'Testing Major Incident Management integration...',
        'info'
      );

      const tests = [
        {
          name: 'Major Incident Management API',
          endpoint: '/api/v1/support/incident-management/major-incident-management',
        },
        { name: 'Config API', endpoint: '/api/v1/support/incident-management/config' },
        {
          name: 'Analytics API',
          endpoint: '/api/v1/support/incident-management/major-incident-management/analytics',
        },
      ];
  ...
  async createRecord() {
    try {
      window.SupportPageManager.showNotification(
        'Creating new major incident management record...',
        'info'
      );
  ...
  async importData() {
    try {
      window.SupportPageManager.showNotification(
        'Importing major incident management data...',
        'info'
      );
  ...
  async viewAnalytics() {
    try {
      window.SupportPageManager.showNotification(
        'Loading major incident management analytics...',
        'info'
      );
  ...
  async exportReport() {
    try {
      window.SupportPageManager.showNotification(
        'Generating major incident management report...',
        'info'
      );
  ...
  async exportData() {
    try {
      window.SupportPageManager.showNotification(
        'Exporting major incident management data...',
        'info'
      );
