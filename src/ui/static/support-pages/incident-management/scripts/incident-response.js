...
class IncidentResponseManager {
  ...
  async loadData() {
    try {
      const response = await window.SupportPageManager.apiRequest(
        '/api/v1/support/incident-management/incident-response'
      );
      ...
      const tests = [
        {
          ...
          endpoint: '/api/v1/support/incident-management/incident-response',
        },
        { name: 'Config API', endpoint: '/api/v1/support/incident-management/config' },
        {
          name: 'Analytics API',
          endpoint: '/api/v1/support/incident-management/incident-response/analytics',
        },
      ];
  ...
  async createRecord() {
    try {
      window.SupportPageManager.showNotification(
        'Creating new incident response record...',
        'info'
      );
