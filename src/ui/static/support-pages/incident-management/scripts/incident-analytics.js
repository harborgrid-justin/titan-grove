...
class IncidentAnalyticsManager {
  ...
  async loadData() {
    try {
      const response = await window.SupportPageManager.apiRequest(
        '/api/v1/support/incident-management/incident-analytics'
      );
  ...
  async testIntegration() {
    try {
      window.SupportPageManager.showNotification(
        'Testing Incident Analytics integration...',
        'info'
      );

      const tests = [
        {
          name: 'Incident Analytics API',
          endpoint: '/api/v1/support/incident-management/incident-analytics',
        },
        { name: 'Config API', endpoint: '/api/v1/support/incident-management/config' },
        {
          name: 'Analytics API',
          endpoint: '/api/v1/support/incident-management/incident-analytics/analytics',
        },
      ];
  ...
  async createRecord() {
    try {
      window.SupportPageManager.showNotification(
        'Creating new incident analytics record...',
        'info'
      );
