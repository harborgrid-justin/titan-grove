...
class IncidentTrackingManager {
  ...
  async loadData() {
    try {
      const response = await window.SupportPageManager.apiRequest(
        '/api/v1/support/incident-management/incident-tracking'
      );
  ...
  async testIntegration() {
    try {
      window.SupportPageManager.showNotification(
        'Testing Incident Tracking integration...',
        'info'
      );
      ...
      const tests = [
        {
          ...
          endpoint: '/api/v1/support/incident-management/incident-tracking',
        },
        { name: 'Config API', endpoint: '/api/v1/support/incident-management/config' },
        {
          name: 'Analytics API',
          endpoint: '/api/v1/support/incident-management/incident-tracking/analytics',
        },
      ];
  ...
  async createRecord() {
    try {
      window.SupportPageManager.showNotification(
        'Creating new incident tracking record...',
        'info'
      );
