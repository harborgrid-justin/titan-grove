...
async function loadcashplanningscenariosData() {
    try {
        const response = await fetch('/api/financial/cash-forecasting-planning/cash-planning-scenarios');
        if (response.ok) {
...
function handlecashplanningscenariosAction() {
    ...
    window.financialPages.showNotification('Cash Planning & Scenarios configured successfully', 'success');
}

function executecashplanningscenarios() {
    console.log('Cash Planning & Scenarios execution started');
    window.financialPages.showNotification('Cash Planning & Scenarios executed successfully', 'success');
}
...
function setupPageActions() {
    ...
    if (testBtn) {
        testBtn.addEventListener('click', async function() {
            try {
                const response = await fetch('/api/financial/cash-forecasting-planning/cash-planning-scenarios/test');
    ...
    if (exportBtn) {
        exportBtn.addEventListener('click', async function() {
            try {
                const response = await fetch('/api/financial/cash-forecasting-planning/cash-planning-scenarios/export');
