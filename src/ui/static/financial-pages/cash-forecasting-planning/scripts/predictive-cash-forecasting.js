...
async function loadpredictivecashforecastingData() {
    try {
        const response = await fetch('/api/financial/cash-forecasting-planning/predictive-cash-forecasting');
        if (response.ok) {
...
function handlepredictivecashforecastingAction() {
    ...
    window.financialPages.showNotification('Predictive Cash Forecasting configured successfully', 'success');
}

function executepredictivecashforecasting() {
    console.log('Predictive Cash Forecasting execution started');
    window.financialPages.showNotification('Predictive Cash Forecasting executed successfully', 'success');
}
...
function setupPageActions() {
    ...
    if (testBtn) {
        testBtn.addEventListener('click', async function() {
            try {
                const response = await fetch('/api/financial/cash-forecasting-planning/predictive-cash-forecasting/test');
    ...
    if (exportBtn) {
        exportBtn.addEventListener('click', async function() {
            try {
                const response = await fetch('/api/financial/cash-forecasting-planning/predictive-cash-forecasting/export');
