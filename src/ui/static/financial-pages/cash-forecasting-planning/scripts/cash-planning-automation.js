...
async function loadcashplanningautomationData() {
  try {
    const response = await fetch(
      '/api/financial/cash-forecasting-planning/cash-planning-automation'
    );
    if (response.ok) {
...
function handlecashplanningautomationAction() {
  ...
  window.financialPages.showNotification(
    'Cash Planning Automation configured successfully',
    'success'
  );
}
...
function executecashplanningautomation() {
  ...
  window.financialPages.showNotification(
    'Cash Planning Automation executed successfully',
    'success'
  );
}
...
function setupPageActions() {
  ...
  if (testBtn) {
    testBtn.addEventListener('click', async function () {
      try {
        const response = await fetch(
          '/api/financial/cash-forecasting-planning/cash-planning-automation/test'
        );
  ...
  if (exportBtn) {
    exportBtn.addEventListener('click', async function () {
      try {
        const response = await fetch(
          '/api/financial/cash-forecasting-planning/cash-planning-automation/export'
        );
