...
function handleleaseaccountingAction() {
    ...
    window.financialPages.showNotification('Lease Accounting (ASC 842) configured successfully', 'success');
}

function executeleaseaccounting() {
    console.log('Lease Accounting (ASC 842) execution started');
    window.financialPages.showNotification('Lease Accounting (ASC 842) executed successfully', 'success');
}
