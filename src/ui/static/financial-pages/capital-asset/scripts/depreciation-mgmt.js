...
function handledepreciationmgmtAction() {
    ...
    window.financialPages.showNotification('Depreciation Management configured successfully', 'success');
}

function executedepreciationmgmt() {
    console.log('Depreciation Management execution started');
    window.financialPages.showNotification('Depreciation Management executed successfully', 'success');
}
