...
function handlecapitalstructureAction() {
    ...
    window.financialPages.showNotification('Capital Structure Analysis configured successfully', 'success');
}

function executecapitalstructure() {
    console.log('Capital Structure Analysis execution started');
    window.financialPages.showNotification('Capital Structure Analysis executed successfully', 'success');
}
