...
function handlecapitalbudgetingAction() {
    ...
    window.financialPages.showNotification('Capital Budgeting & Planning configured successfully', 'success');
}

function executecapitalbudgeting() {
    console.log('Capital Budgeting & Planning execution started');
    window.financialPages.showNotification('Capital Budgeting & Planning executed successfully', 'success');
}
