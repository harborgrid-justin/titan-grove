...
function handlecompliancemonitoringAction() {
    ...
    window.financialPages.showNotification('Cash Compliance Monitoring configured successfully', 'success');
}

function executecompliancemonitoring() {
    console.log('Cash Compliance Monitoring execution started');
    window.financialPages.showNotification('Cash Compliance Monitoring executed successfully', 'success');
}
...
function setupPageActions() {
    ...
    if (testBtn) {
        testBtn.addEventListener('click', async function() {
            try {
                const response = await fetch('/api/financial/cash-risk-compliance/compliance-monitoring/test');
    ...
    if (exportBtn) {
        exportBtn.addEventListener('click', async function() {
            try {
                const response = await fetch('/api/financial/cash-risk-compliance/compliance-monitoring/export');
