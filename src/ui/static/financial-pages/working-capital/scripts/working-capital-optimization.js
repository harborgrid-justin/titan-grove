...
function handleworkingcapitaloptimizationAction() {
    ...
    window.financialPages.showNotification('Working Capital Optimization configured successfully', 'success');
}

function executeworkingcapitaloptimization() {
    console.log('Working Capital Optimization execution started');
    window.financialPages.showNotification('Working Capital Optimization executed successfully', 'success');
}
...
function setupPageActions() {
    ...
    if (testBtn) {
        testBtn.addEventListener('click', async function() {
            try {
                const response = await fetch('/api/financial/working-capital/working-capital-optimization/test');
    ...
    if (exportBtn) {
        exportBtn.addEventListener('click', async function() {
            try {
                const response = await fetch('/api/financial/working-capital/working-capital-optimization/export');
