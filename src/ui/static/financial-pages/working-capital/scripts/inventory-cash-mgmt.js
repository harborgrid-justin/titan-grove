...
function handleinventorycashmgmtAction() {
    ...
    window.financialPages.showNotification('Inventory Cash Management configured successfully', 'success');
}

function executeinventorycashmgmt() {
    console.log('Inventory Cash Management execution started');
    window.financialPages.showNotification('Inventory Cash Management executed successfully', 'success');
}
