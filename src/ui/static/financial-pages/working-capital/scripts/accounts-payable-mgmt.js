...
function handleaccountspayablemgmtAction() {
    ...
    window.financialPages.showNotification('Accounts Payable Management configured successfully', 'success');
}

function executeaccountspayablemgmt() {
    console.log('Accounts Payable Management execution started');
    window.financialPages.showNotification('Accounts Payable Management executed successfully', 'success');
}
