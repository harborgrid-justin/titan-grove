...
function handletradefinancemgmtAction() {
    ...
    window.financialPages.showNotification('Trade Finance Management configured successfully', 'success');
}

function executetradefinancemgmt() {
    console.log('Trade Finance Management execution started');
    window.financialPages.showNotification('Trade Finance Management executed successfully', 'success');
}
