...
function handleaccountsreceivablemgmtAction() {
  ...
  window.financialPages.showNotification(
    'Accounts Receivable Management configured successfully',
    'success'
  );
}
...
function executeaccountsreceivablemgmt() {
  ...
  window.financialPages.showNotification(
    'Accounts Receivable Management executed successfully',
    'success'
  );
}
...
function setupPageActions() {
    ...
    testBtn.addEventListener('click', async function () {
      try {
        const response = await fetch(
          '/api/financial/working-capital/accounts-receivable-mgmt/test'
        );
  ...
  if (exportBtn) {
    exportBtn.addEventListener('click', async function () {
      try {
        const response = await fetch(
          '/api/financial/working-capital/accounts-receivable-mgmt/export'
        );
