...
function handleworkingcapitalanalyticsAction() {
  ...
  window.financialPages.showNotification(
    'Working Capital Analytics configured successfully',
    'success'
  );
}
...
function executeworkingcapitalanalytics() {
  ...
  window.financialPages.showNotification(
    'Working Capital Analytics executed successfully',
    'success'
  );
}
...
function setupPageActions() {
    ...
    testBtn.addEventListener('click', async function () {
      try {
        const response = await fetch(
          '/api/financial/working-capital/working-capital-analytics/test'
        );
  ...
  if (exportBtn) {
    exportBtn.addEventListener('click', async function () {
      try {
        const response = await fetch(
          '/api/financial/working-capital/working-capital-analytics/export'
        );
