...
async function loadtreasurycommunicationsData() {
    try {
        const response = await fetch('/api/financial/treasury-operations-advanced/treasury-communications');
        if (response.ok) {
...
function handletreasurycommunicationsAction() {
    ...
    window.financialPages.showNotification('Treasury Communications Hub configured successfully', 'success');
}

function executetreasurycommunications() {
    console.log('Treasury Communications Hub execution started');
    window.financialPages.showNotification('Treasury Communications Hub executed successfully', 'success');
}
...
function setupPageActions() {
    ...
    if (testBtn) {
        testBtn.addEventListener('click', async function() {
            try {
                const response = await fetch('/api/financial/treasury-operations-advanced/treasury-communications/test');
    ...
    if (exportBtn) {
        exportBtn.addEventListener('click', async function() {
            try {
                const response = await fetch('/api/financial/treasury-operations-advanced/treasury-communications/export');
