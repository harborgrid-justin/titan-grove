...
function handletreasurymobileAction() {
  ...
  window.financialPages.showNotification(
    'Treasury Mobile Platform configured successfully',
    'success'
  );
}
...
function executetreasurymobile() {
  ...
  window.financialPages.showNotification(
    'Treasury Mobile Platform executed successfully',
    'success'
  );
}
...
function setupPageActions() {
    ...
    testBtn.addEventListener('click', async function () {
      try {
        const response = await fetch(
          '/api/financial/treasury-operations-advanced/treasury-mobile/test'
        );
  ...
  if (exportBtn) {
    exportBtn.addEventListener('click', async function () {
      try {
        const response = await fetch(
          '/api/financial/treasury-operations-advanced/treasury-mobile/export'
        );
