...
function handletreasuryautomationAction() {
  ...
  window.financialPages.showNotification(
    'Treasury Process Automation configured successfully',
    'success'
  );
}
...
function executetreasuryautomation() {
  ...
  window.financialPages.showNotification(
    'Treasury Process Automation executed successfully',
    'success'
  );
}
...
function setupPageActions() {
    ...
    testBtn.addEventListener('click', async function () {
      try {
        const response = await fetch(
          '/api/financial/treasury-operations-advanced/treasury-automation/test'
        );
  ...
  if (exportBtn) {
    exportBtn.addEventListener('click', async function () {
      try {
        const response = await fetch(
          '/api/financial/treasury-operations-advanced/treasury-automation/export'
        );
