...
function handletreasurysettlementAction() {
  ...
  window.financialPages.showNotification(
    'Treasury Settlement Management configured successfully',
    'success'
  );
}
...
function executetreasurysettlement() {
  ...
  window.financialPages.showNotification(
    'Treasury Settlement Management executed successfully',
    'success'
  );
}
...
function setupPageActions() {
    ...
    testBtn.addEventListener('click', async function () {
      try {
        const response = await fetch(
          '/api/financial/treasury-operations-advanced/treasury-settlement/test'
        );
  ...
  if (exportBtn) {
    exportBtn.addEventListener('click', async function () {
      try {
        const response = await fetch(
          '/api/financial/treasury-operations-advanced/treasury-settlement/export'
        );
