...
function handletreasuryreportingAction() {
  ...
  window.financialPages.showNotification(
    'Treasury Reporting Suite configured successfully',
    'success'
  );
}
...
function executetreasuryreporting() {
  ...
  window.financialPages.showNotification(
    'Treasury Reporting Suite executed successfully',
    'success'
  );
}
...
function setupPageActions() {
    ...
    testBtn.addEventListener('click', async function () {
      try {
        const response = await fetch(
          '/api/financial/treasury-operations-advanced/treasury-reporting/test'
        );
  ...
  if (exportBtn) {
    exportBtn.addEventListener('click', async function () {
      try {
        const response = await fetch(
          '/api/financial/treasury-operations-advanced/treasury-reporting/export'
        );
