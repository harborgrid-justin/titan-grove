...
function handlebudgetplanningAction() {
    ...
    window.financialPages.showNotification('Budget Planning & Control configured successfully', 'success');
}

function executebudgetplanning() {
    console.log('Budget Planning & Control execution started');
    window.financialPages.showNotification('Budget Planning & Control executed successfully', 'success');
}
