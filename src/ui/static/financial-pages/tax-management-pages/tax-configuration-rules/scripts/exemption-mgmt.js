...
function handleexemptionmgmtAction() {
    ...
    if (window.financialPages) {
        window.financialPages.showNotification('Tax Exemption Management configured successfully', 'success');
    }
}
...
function executeexemptionmgmt() {
    ...
    if (window.financialPages) {
        window.financialPages.showNotification('Tax Exemption Management executed successfully', 'success');
    }
}
...
function setupTaxPageActions() {
    ...
    if (testBtn) {
        testBtn.addEventListener('click', async function() {
            try {
                const response = await fetch('/api/tax-management/tax-configuration-rules/exemption-mgmt/test');
    ...
    if (exportBtn) {
        exportBtn.addEventListener('click', async function() {
            try {
                const response = await fetch('/api/tax-management/tax-configuration-rules/exemption-mgmt/export');
