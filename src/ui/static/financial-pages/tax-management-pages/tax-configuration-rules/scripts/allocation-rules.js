...
function handleallocationrulesAction() {
    ...
    if (window.financialPages) {
        window.financialPages.showNotification('Tax Allocation Rules configured successfully', 'success');
    }
}
...
function setupTaxPageActions() {
    ...
    if (testBtn) {
        testBtn.addEventListener('click', async function() {
            try {
                const response = await fetch('/api/tax-management/tax-configuration-rules/allocation-rules/test');
    ...
    if (exportBtn) {
        exportBtn.addEventListener('click', async function() {
            try {
                const response = await fetch('/api/tax-management/tax-configuration-rules/allocation-rules/export');
