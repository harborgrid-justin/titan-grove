...
function handleregulatoryfilingAction() {
    ...
    if (window.financialPages) {
        window.financialPages.showNotification('Regulatory Tax Filing configured successfully', 'success');
    }
}
...
function executeregulatoryfiling() {
    ...
    if (window.financialPages) {
        window.financialPages.showNotification('Regulatory Tax Filing executed successfully', 'success');
    }
}
...
function setupTaxPageActions() {
    ...
    if (testBtn) {
        testBtn.addEventListener('click', async function() {
            try {
                const response = await fetch('/api/tax-management/tax-compliance-reporting/regulatory-filing/test');
    ...
    if (exportBtn) {
        exportBtn.addEventListener('click', async function() {
            try {
                const response = await fetch('/api/tax-management/tax-compliance-reporting/regulatory-filing/export');
