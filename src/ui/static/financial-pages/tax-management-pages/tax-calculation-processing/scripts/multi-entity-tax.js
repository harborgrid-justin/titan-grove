...
function handlemultientitytaxAction() {
    ...
    if (window.financialPages) {
        window.financialPages.showNotification('Multi-Entity Tax Processing configured successfully', 'success');
    }
}
...
function executemultientitytax() {
    ...
    if (window.financialPages) {
        window.financialPages.showNotification('Multi-Entity Tax Processing executed successfully', 'success');
    }
}
...
function setupTaxPageActions() {
    ...
    if (testBtn) {
        testBtn.addEventListener('click', async function() {
            try {
                const response = await fetch('/api/tax-management/tax-calculation-processing/multi-entity-tax/test');
    ...
    if (exportBtn) {
        exportBtn.addEventListener('click', async function() {
            try {
                const response = await fetch('/api/tax-management/tax-calculation-processing/multi-entity-tax/export');
