...
function handletransferpricingAction() {
    ...
    if (window.financialPages) {
        window.financialPages.showNotification('Transfer Pricing Management configured successfully', 'success');
    }
}
...
function executetransferpricing() {
    ...
    if (window.financialPages) {
        window.financialPages.showNotification('Transfer Pricing Management executed successfully', 'success');
    }
}
...
function setupTaxPageActions() {
    ...
    if (testBtn) {
        testBtn.addEventListener('click', async function() {
            try {
                const response = await fetch('/api/tax-management/international-tax-mgmt/transfer-pricing/test');
    ...
    if (exportBtn) {
        exportBtn.addEventListener('click', async function() {
            try {
                const response = await fetch('/api/tax-management/international-tax-mgmt/transfer-pricing/export');
