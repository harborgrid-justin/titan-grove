...
function handleforeignopstaxAction() {
    ...
    if (window.financialPages) {
        window.financialPages.showNotification('Foreign Operations Tax Management configured successfully', 'success');
    }
}
...
function executeforeignopstax() {
    ...
    if (window.financialPages) {
        window.financialPages.showNotification('Foreign Operations Tax Management executed successfully', 'success');
    }
}
...
function setupTaxPageActions() {
    ...
    if (testBtn) {
        testBtn.addEventListener('click', async function() {
            try {
                const response = await fetch('/api/tax-management/international-tax-mgmt/foreign-ops-tax/test');
    ...
    if (exportBtn) {
        exportBtn.addEventListener('click', async function() {
            try {
                const response = await fetch('/api/tax-management/international-tax-mgmt/foreign-ops-tax/export');
