...
function handletaxoptimizationAction() {
    ...
    if (window.financialPages) {
        window.financialPages.showNotification('Tax Optimization Engine configured successfully', 'success');
    }
}
...
function executetaxoptimization() {
    ...
    if (window.financialPages) {
        window.financialPages.showNotification('Tax Optimization Engine executed successfully', 'success');
    }
}
...
function setupTaxPageActions() {
    ...
    if (testBtn) {
        testBtn.addEventListener('click', async function() {
            try {
                const response = await fetch('/api/tax-management/tax-analytics-intelligence/tax-optimization/test');
    ...
    if (exportBtn) {
        exportBtn.addEventListener('click', async function() {
            try {
                const response = await fetch('/api/tax-management/tax-analytics-intelligence/tax-optimization/export');
