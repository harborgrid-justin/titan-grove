...
function handlecashforecastingAction() {
    ...
    window.financialPages.showNotification('Advanced Cash Forecasting configured successfully', 'success');
}

function executecashforecasting() {
    console.log('Advanced Cash Forecasting execution started');
    window.financialPages.showNotification('Advanced Cash Forecasting executed successfully', 'success');
}
