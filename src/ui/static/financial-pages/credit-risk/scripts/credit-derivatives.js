...
function handlecreditderivativesAction() {
    ...
    window.financialPages.showNotification('Credit Derivatives & Hedging configured successfully', 'success');
}

function executecreditderivatives() {
    console.log('Credit Derivatives & Hedging execution started');
    window.financialPages.showNotification('Credit Derivatives & Hedging executed successfully', 'success');
}
