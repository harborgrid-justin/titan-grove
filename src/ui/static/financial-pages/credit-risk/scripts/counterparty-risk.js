...
function handlecounterpartyriskAction() {
    ...
    window.financialPages.showNotification('Counterparty Risk Management configured successfully', 'success');
}

function executecounterpartyrisk() {
    console.log('Counterparty Risk Management execution started');
    window.financialPages.showNotification('Counterparty Risk Management executed successfully', 'success');
}
