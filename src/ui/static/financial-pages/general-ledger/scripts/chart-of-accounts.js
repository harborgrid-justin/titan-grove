...
function handlechartofaccountsAction() {
    ...
    window.financialPages.showNotification('Advanced Chart of Accounts configured successfully', 'success');
}

function executechartofaccounts() {
    console.log('Advanced Chart of Accounts execution started');
    window.financialPages.showNotification('Advanced Chart of Accounts executed successfully', 'success');
}
