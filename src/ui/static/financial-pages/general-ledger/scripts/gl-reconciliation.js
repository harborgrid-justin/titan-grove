...
function handleglreconciliationAction() {
    ...
    window.financialPages.showNotification('General Ledger Reconciliation configured successfully', 'success');
}

function executeglreconciliation() {
    console.log('General Ledger Reconciliation execution started');
    window.financialPages.showNotification('General Ledger Reconciliation executed successfully', 'success');
}
