...
function handlejournalentriesAction() {
    ...
    window.financialPages.showNotification('Journal Entry Management configured successfully', 'success');
}

function executejournalentries() {
    console.log('Journal Entry Management execution started');
    window.financialPages.showNotification('Journal Entry Management executed successfully', 'success');
}
