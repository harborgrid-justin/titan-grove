...
function handlemulticurrencyAction() {
    ...
    window.financialPages.showNotification('Multi-Currency Management configured successfully', 'success');
}

function executemulticurrency() {
    console.log('Multi-Currency Management execution started');
    window.financialPages.showNotification('Multi-Currency Management executed successfully', 'success');
}
