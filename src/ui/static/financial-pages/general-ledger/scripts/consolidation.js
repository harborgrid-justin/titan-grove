...
function handleconsolidationAction() {
    ...
    window.financialPages.showNotification('Consolidation Management configured successfully', 'success');
}

function executeconsolidation() {
    console.log('Consolidation Management execution started');
    window.financialPages.showNotification('Consolidation Management executed successfully', 'success');
}
