...
function handleinvestmentanalysisAction() {
    ...
    window.financialPages.showNotification('Investment Analysis & ROI configured successfully', 'success');
}

function executeinvestmentanalysis() {
    console.log('Investment Analysis & ROI execution started');
    window.financialPages.showNotification('Investment Analysis & ROI executed successfully', 'success');
}
...
function setupPageActions() {
    ...
    if (exportBtn) {
        exportBtn.addEventListener('click', async function() {
            try {
                const response = await fetch('/api/financial/strategic-planning/investment-analysis/export');
