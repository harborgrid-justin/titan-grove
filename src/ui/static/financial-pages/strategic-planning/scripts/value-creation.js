...
function handlevaluecreationAction() {
    ...
    window.financialPages.showNotification('Value Creation Analysis configured successfully', 'success');
}

function executevaluecreation() {
    console.log('Value Creation Analysis execution started');
    window.financialPages.showNotification('Value Creation Analysis executed successfully', 'success');
}
