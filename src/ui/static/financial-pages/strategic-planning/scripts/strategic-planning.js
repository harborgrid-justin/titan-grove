...
function handlestrategicplanningAction() {
    ...
    window.financialPages.showNotification('Strategic Financial Planning configured successfully', 'success');
}

function executestrategicplanning() {
    console.log('Strategic Financial Planning execution started');
    window.financialPages.showNotification('Strategic Financial Planning executed successfully', 'success');
}
