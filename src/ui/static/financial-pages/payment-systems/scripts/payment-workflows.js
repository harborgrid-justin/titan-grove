...
function handlepaymentworkflowsAction() {
    ...
    window.financialPages.showNotification('Payment Workflow Automation configured successfully', 'success');
}

function executepaymentworkflows() {
    console.log('Payment Workflow Automation execution started');
    window.financialPages.showNotification('Payment Workflow Automation executed successfully', 'success');
}
