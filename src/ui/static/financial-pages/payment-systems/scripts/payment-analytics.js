...
function handlepaymentanalyticsAction() {
    ...
    window.financialPages.showNotification('Payment Analytics & Intelligence configured successfully', 'success');
}

function executepaymentanalytics() {
    console.log('Payment Analytics & Intelligence execution started');
    window.financialPages.showNotification('Payment Analytics & Intelligence executed successfully', 'success');
}
