...
function handlepaymentsecurityAction() {
    ...
    window.financialPages.showNotification('Payment Security & Fraud Prevention configured successfully', 'success');
}

function executepaymentsecurity() {
    console.log('Payment Security & Fraud Prevention execution started');
    window.financialPages.showNotification('Payment Security & Fraud Prevention executed successfully', 'success');
}
