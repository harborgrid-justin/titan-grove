...
function handlepaymentprocessinghubAction() {
    ...
    window.financialPages.showNotification('Payment Processing Hub configured successfully', 'success');
}
...
function setupPageActions() {
    ...
    if (exportBtn) {
        exportBtn.addEventListener('click', async function() {
            try {
                const response = await fetch('/api/financial/payment-systems/payment-processing-hub/export');
