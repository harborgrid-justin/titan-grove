...
function handlecrossborderpaymentsAction() {
    ...
    window.financialPages.showNotification('Cross-Border Payment Management configured successfully', 'success');
}

function executecrossborderpayments() {
    console.log('Cross-Border Payment Management execution started');
    window.financialPages.showNotification('Cross-Border Payment Management executed successfully', 'success');
}
