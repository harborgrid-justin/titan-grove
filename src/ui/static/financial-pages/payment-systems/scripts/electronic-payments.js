...
function handleelectronicpaymentsAction() {
    ...
    window.financialPages.showNotification('Electronic Payment Systems configured successfully', 'success');
}

function executeelectronicpayments() {
    console.log('Electronic Payment Systems execution started');
    window.financialPages.showNotification('Electronic Payment Systems executed successfully', 'success');
}
