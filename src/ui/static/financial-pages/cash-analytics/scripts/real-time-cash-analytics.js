...
function handlerealtimecashanalyticsAction() {
    ...
    window.financialPages.showNotification('Real-Time Cash Analytics configured successfully', 'success');
}

function executerealtimecashanalytics() {
    console.log('Real-Time Cash Analytics execution started');
    window.financialPages.showNotification('Real-Time Cash Analytics executed successfully', 'success');
}
...
function setupPageActions() {
    ...
    if (exportBtn) {
        exportBtn.addEventListener('click', async function() {
            try {
                const response = await fetch('/api/financial/cash-analytics/real-time-cash-analytics/export');
