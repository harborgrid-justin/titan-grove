...
function handlecashattributionanalysisAction() {
  ...
  window.financialPages.showNotification(
    'Cash Attribution Analysis configured successfully',
    'success'
  );
}
...
function executecashattributionanalysis() {
  ...
  window.financialPages.showNotification(
    'Cash Attribution Analysis executed successfully',
    'success'
  );
}
...
function setupPageActions() {
    ...
    testBtn.addEventListener('click', async function () {
      try {
        const response = await fetch(
          '/api/financial/cash-analytics/cash-attribution-analysis/test'
        );
  ...
  if (exportBtn) {
    exportBtn.addEventListener('click', async function () {
      try {
        const response = await fetch(
          '/api/financial/cash-analytics/cash-attribution-analysis/export'
        );
