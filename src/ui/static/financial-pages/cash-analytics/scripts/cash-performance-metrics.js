...
function handlecashperformancemetricsAction() {
    ...
    window.financialPages.showNotification('Cash Performance Metrics configured successfully', 'success');
}

function executecashperformancemetrics() {
    console.log('Cash Performance Metrics execution started');
    window.financialPages.showNotification('Cash Performance Metrics executed successfully', 'success');
}
...
function setupPageActions() {
    ...
    if (exportBtn) {
        exportBtn.addEventListener('click', async function() {
            try {
                const response = await fetch('/api/financial/cash-analytics/cash-performance-metrics/export');
