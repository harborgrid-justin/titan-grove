...
function handlefinancialcloseAction() {
    ...
    window.financialPages.showNotification('Financial Close Automation configured successfully', 'success');
}

function executefinancialclose() {
    console.log('Financial Close Automation execution started');
    window.financialPages.showNotification('Financial Close Automation executed successfully', 'success');
}
