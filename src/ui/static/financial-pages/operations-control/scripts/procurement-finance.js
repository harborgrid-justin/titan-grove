...
function handleprocurementfinanceAction() {
  ...
  window.financialPages.showNotification(
    'Procurement Finance Integration configured successfully',
    'success'
  );
}
...
function executeprocurementfinance() {
  ...
  window.financialPages.showNotification(
    'Procurement Finance Integration executed successfully',
    'success'
  );
}
    ...
    exportBtn.addEventListener('click', async function () {
      try {
        const response = await fetch(
          '/api/financial/operations-control/procurement-finance/export'
        );
