...
function handleintercompanyaccountingAction() {
    ...
    window.financialPages.showNotification('Intercompany Accounting configured successfully', 'success');
}

function executeintercompanyaccounting() {
    console.log('Intercompany Accounting execution started');
    window.financialPages.showNotification('Intercompany Accounting executed successfully', 'success');
}
...
function setupPageActions() {
    ...
    if (testBtn) {
        testBtn.addEventListener('click', async function() {
            try {
                const response = await fetch('/api/financial/operations-control/intercompany-accounting/test');
    ...
    if (exportBtn) {
        exportBtn.addEventListener('click', async function() {
            try {
                const response = await fetch('/api/financial/operations-control/intercompany-accounting/export');
