...
function handleexpensemanagementAction() {
    ...
    window.financialPages.showNotification('Expense Management & Control configured successfully', 'success');
}

function executeexpensemanagement() {
    console.log('Expense Management & Control execution started');
    window.financialPages.showNotification('Expense Management & Control executed successfully', 'success');
}
