...
function handlefinancialcontrolsAction() {
    ...
    window.financialPages.showNotification('Financial Controls Framework configured successfully', 'success');
}

function executefinancialcontrols() {
    console.log('Financial Controls Framework execution started');
    window.financialPages.showNotification('Financial Controls Framework executed successfully', 'success');
}
