...
function handlejournalautomationAction() {
    ...
    window.financialPages.showNotification('Journal Entry Automation configured successfully', 'success');
}

function executejournalautomation() {
    console.log('Journal Entry Automation execution started');
    window.financialPages.showNotification('Journal Entry Automation executed successfully', 'success');
}
