...
function handlevendorcomplianceAction() {
  ...
  window.financialPages.showNotification(
    'Vendor Compliance Management configured successfully',
    'success'
  );
}
...
function executevendorcompliance() {
  ...
  window.financialPages.showNotification(
    'Vendor Compliance Management executed successfully',
    'success'
  );
}
    ...
    exportBtn.addEventListener('click', async function () {
      try {
        const response = await fetch(
          '/api/financial/compliance-governance/vendor-compliance/export'
        );
