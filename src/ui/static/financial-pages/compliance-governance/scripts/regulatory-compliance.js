...
function handleregulatorycomplianceAction() {
  ...
  window.financialPages.showNotification(
    'Regulatory Compliance Hub configured successfully',
    'success'
  );
}
...
function executeregulatorycompliance() {
  ...
  window.financialPages.showNotification(
    'Regulatory Compliance Hub executed successfully',
    'success'
  );
}
...
function setupPageActions() {
    ...
    testBtn.addEventListener('click', async function () {
      try {
        const response = await fetch(
          '/api/financial/compliance-governance/regulatory-compliance/test'
        );
  ...
  if (exportBtn) {
    exportBtn.addEventListener('click', async function () {
      try {
        const response = await fetch(
          '/api/financial/compliance-governance/regulatory-compliance/export'
        );
