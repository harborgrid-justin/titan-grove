...
function handlegovernancereportingAction() {
    ...
    window.financialPages.showNotification('Corporate Governance Reporting configured successfully', 'success');
}

function executegovernancereporting() {
    console.log('Corporate Governance Reporting execution started');
    window.financialPages.showNotification('Corporate Governance Reporting executed successfully', 'success');
}
...
function setupPageActions() {
    ...
    if (testBtn) {
        testBtn.addEventListener('click', async function() {
            try {
                const response = await fetch('/api/financial/compliance-governance/governance-reporting/test');
    ...
    if (exportBtn) {
        exportBtn.addEventListener('click', async function() {
            try {
                const response = await fetch('/api/financial/compliance-governance/governance-reporting/export');
