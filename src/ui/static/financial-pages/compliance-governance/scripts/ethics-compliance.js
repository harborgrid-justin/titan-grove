...
function handleethicscomplianceAction() {
  ...
  window.financialPages.showNotification(
    'Ethics & Conduct Compliance configured successfully',
    'success'
  );
}
...
function executeethicscompliance() {
  ...
  window.financialPages.showNotification(
    'Ethics & Conduct Compliance executed successfully',
    'success'
  );
}
    ...
    exportBtn.addEventListener('click', async function () {
      try {
        const response = await fetch(
          '/api/financial/compliance-governance/ethics-compliance/export'
        );
