...
class CRMManagementSystem {
    ...
    generateSampleDeals() {
        const companies = [
            'Innovation Labs', 'Future Systems', 'Digital Dynamics', 'Smart Solutions',
            'Advanced Analytics', 'Cloud Computing Corp', 'Enterprise Solutions',
            'Technology Partners', 'Business Innovations', 'Data Intelligence'
        ];
        ...
        this.activities = [
            {
                ...
                description: 'Jennifer Wilson conducted discovery call with TechCorp Inc. regarding enterprise platform requirements.',
            ...
            },
            {
                ...
                description: 'Robert Chen presented comprehensive product demo to Global Systems stakeholder team.',
            ...
            },
            {
                ...
                description: 'Lisa Anderson sent detailed follow-up with ROI analysis to DataFlow Corp decision makers.',
            ...
            },
            {
                ...
                description: 'Successfully closed enterprise deal with Innovation Labs for comprehensive business suite implementation.',
    ...
    async createRevenueTrendChart() {
        ...
        const revenueData = [3800000, 3650000, 4100000, 3950000, 4300000, 4150000, 4500000, 4200000, 4650000, 4800000, 5200000, 4200000];
        const targetData = [4000000, 4000000, 4000000, 4000000, 4000000, 4000000, 4000000, 4000000, 4000000, 4000000, 4000000, 4000000];
    ...
    async createTeamPerformanceChart() {
        ...
        const teams = ['Enterprise Sales', 'SMB Sales', 'Channel Partners', 'Inside Sales', 'Customer Success'];
    ...
    initializePipeline() {
        ...
        const stages = ['leadsStage', 'qualifiedStage', 'proposalStage', 'negotiationStage', 'closedStage'];
    ...
    populatePipelineStages() {
        ...
        Object.entries(stages).forEach(([elementId, stageName]) => {
            ...
            const stageDeals = this.deals
                .filter(deal => deal.stage === stageName)
                .slice(0, 10); // Limit to 10 deals per stage for performance
    ...
    createDealCard(deal) {
        ...
        const riskIndicator = deal.riskLevel === 'high' ? 
    ...
    switchSection(sectionId) {
        ...
        const targetSection = document.getElementById(sectionId === 'dashboard' ? 'crm-dashboard' : `${sectionId}-management`);
        if (targetSection) {
    ...
    calculateSalesMetrics() {
        const activeDeals = this.deals.filter(deal => deal.stage !== 'closed' && deal.stage !== 'lost');
