...
class TitanGroveSetupEngine {
    ...
    async checkSystemMemory() {
        ...
        return availableMemory >= requiredMemory
            ...
            : { status: 'ERROR', message: `Insufficient memory: ${availableMemory}GB (${requiredMemory}GB required)` };
    }
    ...
    getStepInfo(stepNumber) {
        const steps = {
            1: { title: 'System Requirements', description: 'Verify system requirements and dependencies' },
            2: { title: 'Database Configuration', description: 'Configure database connections and settings' },
            3: { title: 'Module Selection', description: 'Choose which modules to install and configure' },
            4: { title: 'Security Configuration', description: 'Set up security settings and authentication' },
