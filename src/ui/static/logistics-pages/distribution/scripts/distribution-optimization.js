...
function handledistributionoptimizationAction() {
  ...
  window.logisticsPages.showNotification(
    'Distribution Center Optimization configured successfully',
    'success'
  );
}
...
function executedistributionoptimization() {
  ...
  window.logisticsPages.showNotification(
    'Distribution Center Optimization operation initiated',
    'info'
  );
  ...
  setTimeout(() => {
    window.logisticsPages.showNotification(
      'Distribution Center Optimization operation completed successfully',
      'success'
    );
  }, 2000);
}
