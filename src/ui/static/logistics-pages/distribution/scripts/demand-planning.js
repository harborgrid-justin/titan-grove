...
function handledemandplanningAction() {
  ...
  window.logisticsPages.showNotification(
    'Demand Planning & Forecasting configured successfully',
    'success'
  );
}
...
function executedemandplanning() {
  ...
  window.logisticsPages.showNotification(
    'Demand Planning & Forecasting operation initiated',
    'info'
  );
  ...
  setTimeout(() => {
    window.logisticsPages.showNotification(
      'Demand Planning & Forecasting operation completed successfully',
      'success'
    );
  }, 2000);
}
