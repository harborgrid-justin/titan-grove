...
function handledigitaltwinAction() {
    ...
    window.logisticsPages.showNotification('Supply Chain Digital Twin configured successfully', 'success');
}
...
function executedigitaltwin() {
    ...
    // Simulate API call
    setTimeout(() => {
        window.logisticsPages.showNotification('Supply Chain Digital Twin operation completed successfully', 'success');
    }, 2000);
}
