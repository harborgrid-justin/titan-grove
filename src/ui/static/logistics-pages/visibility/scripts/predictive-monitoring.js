...
function handlepredictivemonitoringAction() {
  ...
  window.logisticsPages.showNotification(
    'Predictive Supply Chain Monitoring configured successfully',
    'success'
  );
}
...
function executepredictivemonitoring() {
  ...
  window.logisticsPages.showNotification(
    'Predictive Supply Chain Monitoring operation initiated',
    'info'
  );
  ...
  setTimeout(() => {
    window.logisticsPages.showNotification(
      'Predictive Supply Chain Monitoring operation completed successfully',
      'success'
    );
  }, 2000);
}
