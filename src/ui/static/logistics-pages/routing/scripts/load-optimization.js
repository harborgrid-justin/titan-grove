...
function handleloadoptimizationAction() {
  ...
  window.logisticsPages.showNotification(
    'Load Planning & Optimization configured successfully',
    'success'
  );
}
...
function executeloadoptimization() {
  ...
  window.logisticsPages.showNotification(
    'Load Planning & Optimization operation initiated',
    'info'
  );
  ...
  setTimeout(() => {
    window.logisticsPages.showNotification(
      'Load Planning & Optimization operation completed successfully',
      'success'
    );
  }, 2000);
}
