...
function handlefreightmanagementAction() {
  ...
  window.logisticsPages.showNotification(
    'Comprehensive Freight Management configured successfully',
    'success'
  );
}
...
function executefreightmanagement() {
  ...
  window.logisticsPages.showNotification(
    'Comprehensive Freight Management operation initiated',
    'info'
  );
  ...
  setTimeout(() => {
    window.logisticsPages.showNotification(
      'Comprehensive Freight Management operation completed successfully',
      'success'
    );
  }, 2000);
}
