...
function handlefreightanalyticsAction() {
  ...
  window.logisticsPages.showNotification(
    'Freight Analytics & Reporting configured successfully',
    'success'
  );
}
...
function executefreightanalytics() {
  ...
  window.logisticsPages.showNotification(
    'Freight Analytics & Reporting operation initiated',
    'info'
  );
  ...
  setTimeout(() => {
    window.logisticsPages.showNotification(
      'Freight Analytics & Reporting operation completed successfully',
      'success'
    );
  }, 2000);
}
