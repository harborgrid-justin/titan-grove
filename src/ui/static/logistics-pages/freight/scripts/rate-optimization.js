...
function handlerateoptimizationAction() {
    ...
    window.logisticsPages.showNotification('Freight Rate Optimization configured successfully', 'success');
}
...
function executerateoptimization() {
    ...
    // Simulate API call
    setTimeout(() => {
        window.logisticsPages.showNotification('Freight Rate Optimization operation completed successfully', 'success');
    }, 2000);
}
