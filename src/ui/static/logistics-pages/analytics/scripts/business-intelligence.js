...
function handlebusinessintelligenceAction() {
  ...
  window.logisticsPages.showNotification(
    'Logistics Business Intelligence configured successfully',
    'success'
  );
}
...
function executebusinessintelligence() {
  ...
  window.logisticsPages.showNotification(
    'Logistics Business Intelligence operation initiated',
    'info'
  );
  ...
  setTimeout(() => {
    window.logisticsPages.showNotification(
      'Logistics Business Intelligence operation completed successfully',
      'success'
    );
  }, 2000);
}
