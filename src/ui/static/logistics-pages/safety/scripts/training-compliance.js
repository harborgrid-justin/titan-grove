...
function handletrainingcomplianceAction() {
  ...
  window.logisticsPages.showNotification(
    'Safety Training & Compliance configured successfully',
    'success'
  );
}
...
function executetrainingcompliance() {
  ...
  window.logisticsPages.showNotification(
    'Safety Training & Compliance operation initiated',
    'info'
  );
  ...
  setTimeout(() => {
    window.logisticsPages.showNotification(
      'Safety Training & Compliance operation completed successfully',
      'success'
    );
  }, 2000);
}
