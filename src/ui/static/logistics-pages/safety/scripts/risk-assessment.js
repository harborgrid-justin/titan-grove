...
function handleriskassessmentAction() {
    ...
    window.logisticsPages.showNotification('Safety Risk Assessment configured successfully', 'success');
}
...
function executeriskassessment() {
    ...
    // Simulate API call
    setTimeout(() => {
        window.logisticsPages.showNotification('Safety Risk Assessment operation completed successfully', 'success');
    }, 2000);
}
