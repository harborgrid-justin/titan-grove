...
function handleincidentmanagementAction() {
    ...
    window.logisticsPages.showNotification('Safety Incident Management configured successfully', 'success');
}
...
function executeincidentmanagement() {
    ...
    // Simulate API call
    setTimeout(() => {
        window.logisticsPages.showNotification('Safety Incident Management operation completed successfully', 'success');
    }, 2000);
}
