...
function handlehazmatmanagementAction() {
  ...
  window.logisticsPages.showNotification(
    'Hazardous Materials Management configured successfully',
    'success'
  );
}
...
function executehazmatmanagement() {
  ...
  window.logisticsPages.showNotification(
    'Hazardous Materials Management operation initiated',
    'info'
  );
  ...
  setTimeout(() => {
    window.logisticsPages.showNotification(
      'Hazardous Materials Management operation completed successfully',
      'success'
    );
  }, 2000);
}
