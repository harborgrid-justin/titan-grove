...
function handlesupplyplanningAction() {
    ...
    window.logisticsPages.showNotification('Strategic Supply Planning configured successfully', 'success');
}
...
function executesupplyplanning() {
    ...
    // Simulate API call
    setTimeout(() => {
        window.logisticsPages.showNotification('Strategic Supply Planning operation completed successfully', 'success');
    }, 2000);
}
