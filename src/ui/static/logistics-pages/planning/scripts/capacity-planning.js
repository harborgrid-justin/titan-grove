...
function handlecapacityplanningAction() {
  ...
  window.logisticsPages.showNotification(
    'Capacity Planning & Management configured successfully',
    'success'
  );
}
...
function executecapacityplanning() {
  ...
  window.logisticsPages.showNotification(
    'Capacity Planning & Management operation initiated',
    'info'
  );
  ...
  setTimeout(() => {
    window.logisticsPages.showNotification(
      'Capacity Planning & Management operation completed successfully',
      'success'
    );
  }, 2000);
}
