...
function handledemandsensingAction() {
    ...
    window.logisticsPages.showNotification('Real-time Demand Sensing configured successfully', 'success');
}
...
function executedemandsensing() {
    ...
    // Simulate API call
    setTimeout(() => {
        window.logisticsPages.showNotification('Real-time Demand Sensing operation completed successfully', 'success');
    }, 2000);
}
