...
function handlewarehouseautomationAction() {
  ...
  window.logisticsPages.showNotification(
    'Warehouse Automation & Robotics configured successfully',
    'success'
  );
}
...
function executewarehouseautomation() {
  ...
  window.logisticsPages.showNotification(
    'Warehouse Automation & Robotics operation initiated',
    'info'
  );
  ...
  setTimeout(() => {
    window.logisticsPages.showNotification(
      'Warehouse Automation & Robotics operation completed successfully',
      'success'
    );
  }, 2000);
}
