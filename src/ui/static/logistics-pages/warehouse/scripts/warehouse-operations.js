...
function handlewarehouseoperationsAction() {
  ...
  window.logisticsPages.showNotification(
    'Warehouse Operations Management configured successfully',
    'success'
  );
}
...
function executewarehouseoperations() {
  ...
  window.logisticsPages.showNotification(
    'Warehouse Operations Management operation initiated',
    'info'
  );
  ...
  setTimeout(() => {
    window.logisticsPages.showNotification(
      'Warehouse Operations Management operation completed successfully',
      'success'
    );
  }, 2000);
}
