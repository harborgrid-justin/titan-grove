...
function handlesourcingoptimizationAction() {
  ...
  window.logisticsPages.showNotification(
    'Strategic Sourcing & Optimization configured successfully',
    'success'
  );
}
...
function executesourcingoptimization() {
  ...
  window.logisticsPages.showNotification(
    'Strategic Sourcing & Optimization operation initiated',
    'info'
  );
  ...
  setTimeout(() => {
    window.logisticsPages.showNotification(
      'Strategic Sourcing & Optimization operation completed successfully',
      'success'
    );
  }, 2000);
}
