...
function handlecompliancemanagementAction() {
  ...
  window.logisticsPages.showNotification(
    'Procurement Compliance Management configured successfully',
    'success'
  );
}
...
function executecompliancemanagement() {
  ...
  window.logisticsPages.showNotification(
    'Procurement Compliance Management operation initiated',
    'info'
  );
  ...
  setTimeout(() => {
    window.logisticsPages.showNotification(
      'Procurement Compliance Management operation completed successfully',
      'success'
    );
  }, 2000);
}
