...
function handlecontractlifecycleAction() {
  ...
  window.logisticsPages.showNotification(
    'Contract Lifecycle Management configured successfully',
    'success'
  );
}
...
function executecontractlifecycle() {
  ...
  window.logisticsPages.showNotification(
    'Contract Lifecycle Management operation initiated',
    'info'
  );
  ...
  setTimeout(() => {
    window.logisticsPages.showNotification(
      'Contract Lifecycle Management operation completed successfully',
      'success'
    );
  }, 2000);
}
