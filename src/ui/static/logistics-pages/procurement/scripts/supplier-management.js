...
function handlesuppliermanagementAction() {
  ...
  window.logisticsPages.showNotification(
    'Strategic Supplier Management configured successfully',
    'success'
  );
}
...
function executesuppliermanagement() {
  ...
  window.logisticsPages.showNotification(
    'Strategic Supplier Management operation initiated',
    'info'
  );
  ...
  setTimeout(() => {
    window.logisticsPages.showNotification(
      'Strategic Supplier Management operation completed successfully',
      'success'
    );
  }, 2000);
}
