...
function handlespendanalyticsAction() {
    ...
    window.logisticsPages.showNotification('Procurement Spend Analytics configured successfully', 'success');
}
...
function executespendanalytics() {
    ...
    // Simulate API call
    setTimeout(() => {
        window.logisticsPages.showNotification('Procurement Spend Analytics operation completed successfully', 'success');
    }, 2000);
}
