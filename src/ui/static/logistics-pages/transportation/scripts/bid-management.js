...
function handlebidmanagementAction() {
  ...
  window.logisticsPages.showNotification(
    'Transportation Bid Management configured successfully',
    'success'
  );
}
...
function executebidmanagement() {
  ...
  window.logisticsPages.showNotification(
    'Transportation Bid Management operation initiated',
    'info'
  );
  ...
  setTimeout(() => {
    window.logisticsPages.showNotification(
      'Transportation Bid Management operation completed successfully',
      'success'
    );
  }, 2000);
}
