...
function handlefleetmanagementAction() {
  ...
  window.logisticsPages.showNotification(
    'Fleet Management & Optimization configured successfully',
    'success'
  );
}
...
function executefleetmanagement() {
  ...
  window.logisticsPages.showNotification(
    'Fleet Management & Optimization operation initiated',
    'info'
  );
  ...
  setTimeout(() => {
    window.logisticsPages.showNotification(
      'Fleet Management & Optimization operation completed successfully',
      'success'
    );
  }, 2000);
}
