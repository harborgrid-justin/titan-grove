...
function handletransportationplanningAction() {
  ...
  window.logisticsPages.showNotification(
    'Transportation Planning & Optimization configured successfully',
    'success'
  );
}
...
function executetransportationplanning() {
  ...
  window.logisticsPages.showNotification(
    'Transportation Planning & Optimization operation initiated',
    'info'
  );
  ...
  setTimeout(() => {
    window.logisticsPages.showNotification(
      'Transportation Planning & Optimization operation completed successfully',
      'success'
    );
  }, 2000);
}
