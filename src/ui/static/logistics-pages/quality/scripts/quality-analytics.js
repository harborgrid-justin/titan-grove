...
function handlequalityanalyticsAction() {
  ...
  window.logisticsPages.showNotification(
    'Quality Analytics & Insights configured successfully',
    'success'
  );
}
...
function executequalityanalytics() {
  ...
  window.logisticsPages.showNotification(
    'Quality Analytics & Insights operation initiated',
    'info'
  );
  ...
  setTimeout(() => {
    window.logisticsPages.showNotification(
      'Quality Analytics & Insights operation completed successfully',
      'success'
    );
  }, 2000);
}
