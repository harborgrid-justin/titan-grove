...
async function loadprivilegedaccessmanagementData() {
    try {
        ...
        const response = await fetch('/api/user-management/access-control/privileged-access-management');
...
function setupPageActions() {
    ...
    if (testBtn) {
        testBtn.addEventListener('click', async function() {
            try {
                const response = await fetch('/api/user-management/access-control/privileged-access-management/test');
