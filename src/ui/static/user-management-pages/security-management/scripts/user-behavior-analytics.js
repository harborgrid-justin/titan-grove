...
async function loaduserbehavioranalyticsData() {
    try {
        ...
        const response = await fetch('/api/user-management/security-management/user-behavior-analytics');
...
function setupPageActions() {
    ...
    if (testBtn) {
        testBtn.addEventListener('click', async function() {
            try {
                const response = await fetch('/api/user-management/security-management/user-behavior-analytics/test');
