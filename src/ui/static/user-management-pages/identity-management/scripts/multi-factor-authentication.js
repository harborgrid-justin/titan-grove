...
async function loadmultifactorauthenticationData() {
    try {
        ...
        const response = await fetch('/api/user-management/identity-management/multi-factor-authentication');
...
function setupPageActions() {
    ...
    if (testBtn) {
        testBtn.addEventListener('click', async function() {
            try {
                const response = await fetch('/api/user-management/identity-management/multi-factor-authentication/test');
