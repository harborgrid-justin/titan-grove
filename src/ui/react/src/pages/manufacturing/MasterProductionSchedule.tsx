...
interface MasterProductionScheduleData {
  id: string;
  name: string;
...
const MasterProductionSchedule: React.FC = () => {
  const [data, setData] = useState<MasterProductionScheduleData[]>([]);
  const [showModal, setShowModal] = useState(false);
  const [editingItem, setEditingItem] = useState<MasterProductionScheduleData | null>(null);
  ...
  const handleSave = (formData: any) => {
    if (editingItem) {
      ...
      const newItem: MasterProductionScheduleData = {
