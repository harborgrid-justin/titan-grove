...
interface FlowManufacturingData {
  id: string;
  name: string;
...
const FlowManufacturing: React.FC = () => {
  const [data, setData] = useState<FlowManufacturingData[]>([]);
  const [showModal, setShowModal] = useState(false);
  const [editingItem, setEditingItem] = useState<FlowManufacturingData | null>(null);
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setData([
        {
          id: 'FLOWMANUFACTURING_001',
          name: 'Sample Flow Manufacturing',
          status: 'ACTIVE',
  ...
  const handleSave = (formData: any) => {
    if (editingItem) {
      ...
      const newItem: FlowManufacturingData = {
    ...
    <div className="page-container">
      ...
      <div className="main-content">
        <div className="page-header">
          <h1>Flow Manufacturing</h1>
          <p>Manage flow manufacturing processes</p>
        </div>
        ...
        <div className="content-section">
          <div className="section-header">
            <h2>Flow Manufacturing Management</h2>
        ...
        {showModal && (
          <CrudModal
            title={editingItem ? 'Edit Flow Manufacturing' : 'Create Flow Manufacturing'}
            fields={modalFields}
...
export default FlowManufacturing;