...
const OEEAnalytics: React.FC = () => {
  const [data, setData] = useState<OEEAnalyticsData[]>([]);
  const [showModal, setShowModal] = useState(false);
  const [editingItem, setEditingItem] = useState<OEEAnalyticsData | null>(null);
  ...
  const handleSave = (formData: any) => {
    if (editingItem) {
      ...
      const newItem: OEEAnalyticsData = {
    ...
    <div className="page-container">
      ...
      <div className="main-content">
        <div className="page-header">
          <h1>OEE Analytics</h1>
          <p>Overall Equipment Effectiveness analytics</p>
        </div>
        ...
        <div className="content-section">
          <div className="section-header">
            <h2>OEE Analytics Management</h2>
        ...
        {showModal && (
          <CrudModal
            title={editingItem ? 'Edit OEE Analytics' : 'Create OEE Analytics'}
            fields={modalFields}
