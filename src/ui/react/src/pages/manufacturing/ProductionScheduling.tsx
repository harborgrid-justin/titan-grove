...
interface ProductionSchedulingData {
  id: string;
  name: string;
...
const ProductionScheduling: React.FC = () => {
  const [data, setData] = useState<ProductionSchedulingData[]>([]);
  const [showModal, setShowModal] = useState(false);
  const [editingItem, setEditingItem] = useState<ProductionSchedulingData | null>(null);
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setData([
        {
          id: 'PRODUCTIONSCHEDULING_001',
          name: 'Sample Production Scheduling',
          status: 'ACTIVE',
  ...
  const handleSave = (formData: any) => {
    if (editingItem) {
      ...
      const newItem: ProductionSchedulingData = {
    ...
    <div className="page-container">
      ...
      <div className="main-content">
        <div className="page-header">
          ...
          <p>Schedule and optimize production activities</p>
        </div>
        ...
        <div className="content-section">
          <div className="section-header">
            <h2>Production Scheduling Management</h2>
        ...
        {showModal && (
          <CrudModal
            title={editingItem ? 'Edit Production Scheduling' : 'Create Production Scheduling'}
            fields={modalFields}
