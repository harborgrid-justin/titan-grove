...
interface CapacityManagementData {
  id: string;
  name: string;
...
const CapacityManagement: React.FC = () => {
  const [data, setData] = useState<CapacityManagementData[]>([]);
  const [showModal, setShowModal] = useState(false);
  const [editingItem, setEditingItem] = useState<CapacityManagementData | null>(null);
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setData([
        {
          id: 'CAPACITYMANAGEMENT_001',
          name: 'Sample Capacity Management',
          status: 'ACTIVE',
  ...
  const handleSave = (formData: any) => {
    if (editingItem) {
      ...
      const newItem: CapacityManagementData = {
    ...
    <div className="page-container">
      ...
      <div className="main-content">
        <div className="page-header">
          ...
          <p>Manage production capacity and utilization</p>
        </div>
        ...
        <div className="content-section">
          <div className="section-header">
            <h2>Capacity Management Management</h2>
        ...
        {showModal && (
          <CrudModal
            title={editingItem ? 'Edit Capacity Management' : 'Create Capacity Management'}
            fields={modalFields}
