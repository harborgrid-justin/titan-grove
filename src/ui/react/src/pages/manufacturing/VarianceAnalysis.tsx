...
const VarianceAnalysis: React.FC = () => {
  ...
  const [editingItem, setEditingItem] = useState<VarianceAnalysisData | null>(null);
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setData([
        {
          id: 'VARIANCEANALYSIS_001',
          name: 'Sample Variance Analysis',
          status: 'ACTIVE',
  ...
  const handleSave = (formData: any) => {
    if (editingItem) {
      ...
      const newItem: VarianceAnalysisData = {
      ...
      <div className="main-content">
        ...
        <div className="content-section">
          <div className="section-header">
            <h2>Variance Analysis Management</h2>
        ...
        {showModal && (
          <CrudModal
            title={editingItem ? 'Edit Variance Analysis' : 'Create Variance Analysis'}
            fields={modalFields}
