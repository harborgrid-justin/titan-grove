    ...
    <div className="page-container">
      ...
      <div className="main-content">
        <div className="page-header">
          ...
          <p>Monitor quality performance metrics</p>
        </div>
        ...
        <div className="content-section">
          <div className="section-header">
            <h2>Quality Metrics Management</h2>
        ...
        {showModal && (
          <CrudModal
            title={editingItem ? 'Edit Quality Metrics' : 'Create Quality Metrics'}
            fields={modalFields}
