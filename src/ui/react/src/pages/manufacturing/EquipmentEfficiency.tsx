...
const EquipmentEfficiency: React.FC = () => {
  const [data, setData] = useState<EquipmentEfficiencyData[]>([]);
  const [showModal, setShowModal] = useState(false);
  const [editingItem, setEditingItem] = useState<EquipmentEfficiencyData | null>(null);
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setData([
        {
          id: 'EQUIPMENTEFFICIENCY_001',
          name: 'Sample Equipment Efficiency',
          status: 'ACTIVE',
  ...
  const handleSave = (formData: any) => {
    if (editingItem) {
      ...
      const newItem: EquipmentEfficiencyData = {
    ...
    <div className="page-container">
      ...
      <div className="main-content">
        <div className="page-header">
          <h1>Equipment Efficiency</h1>
          <p>Monitor equipment efficiency</p>
        </div>
        ...
        <div className="content-section">
          <div className="section-header">
            <h2>Equipment Efficiency Management</h2>
        ...
        {showModal && (
          <CrudModal
            title={editingItem ? 'Edit Equipment Efficiency' : 'Create Equipment Efficiency'}
            fields={modalFields}
