...
interface SixSigmaProjectsData {
  id: string;
  name: string;
...
const SixSigmaProjects: React.FC = () => {
  const [data, setData] = useState<SixSigmaProjectsData[]>([]);
  const [showModal, setShowModal] = useState(false);
  const [editingItem, setEditingItem] = useState<SixSigmaProjectsData | null>(null);
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setData([
        {
          id: 'SIXSIGMAPROJECTS_001',
          name: 'Sample Six Sigma Projects',
          status: 'ACTIVE',
  ...
  const handleSave = (formData: any) => {
    if (editingItem) {
      ...
      const newItem: SixSigmaProjectsData = {
    ...
    <div className="page-container">
      ...
      <div className="main-content">
        <div className="page-header">
          <h1>Six Sigma Projects</h1>
          <p>Manage Six Sigma improvement projects</p>
        </div>
        ...
        <div className="content-section">
          <div className="section-header">
            <h2>Six Sigma Projects Management</h2>
        ...
        {showModal && (
          <CrudModal
            title={editingItem ? 'Edit Six Sigma Projects' : 'Create Six Sigma Projects'}
            fields={modalFields}
...
export default SixSigmaProjects;