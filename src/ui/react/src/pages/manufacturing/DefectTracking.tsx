...
const DefectTracking: React.FC = () => {
  const [data, setData] = useState<DefectTrackingData[]>([]);
  const [showModal, setShowModal] = useState(false);
  const [editingItem, setEditingItem] = useState<DefectTrackingData | null>(null);
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setData([
        {
          id: 'DEFECTTRACKING_001',
          name: 'Sample Defect Tracking',
          status: 'ACTIVE',
  ...
  const handleSave = (formData: any) => {
    if (editingItem) {
      ...
      const newItem: DefectTrackingData = {
    ...
    <div className="page-container">
      ...
      <div className="main-content">
        <div className="page-header">
          ...
          <p>Track and manage product defects</p>
        </div>
        ...
        <div className="content-section">
          <div className="section-header">
            <h2>Defect Tracking Management</h2>
        ...
        {showModal && (
          <CrudModal
            title={editingItem ? 'Edit Defect Tracking' : 'Create Defect Tracking'}
            fields={modalFields}
