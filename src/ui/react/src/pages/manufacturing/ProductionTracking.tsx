...
const ProductionTracking: React.FC = () => {
  const [data, setData] = useState<ProductionTrackingData[]>([]);
  const [showModal, setShowModal] = useState(false);
  const [editingItem, setEditingItem] = useState<ProductionTrackingData | null>(null);
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setData([
        {
          id: 'PRODUCTIONTRACKING_001',
          name: 'Sample Production Tracking',
          status: 'ACTIVE',
  ...
  const handleSave = (formData: any) => {
    if (editingItem) {
      ...
      const newItem: ProductionTrackingData = {
    ...
    <div className="page-container">
      ...
      <div className="main-content">
        <div className="page-header">
          ...
          <p>Track production progress in real-time</p>
        </div>
        ...
        <div className="content-section">
          <div className="section-header">
            <h2>Production Tracking Management</h2>
        ...
        {showModal && (
          <CrudModal
            title={editingItem ? 'Edit Production Tracking' : 'Create Production Tracking'}
            fields={modalFields}
