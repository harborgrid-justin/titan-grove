...
interface OperatorInterfaceData {
  id: string;
  name: string;
...
const OperatorInterface: React.FC = () => {
  const [data, setData] = useState<OperatorInterfaceData[]>([]);
  const [showModal, setShowModal] = useState(false);
  const [editingItem, setEditingItem] = useState<OperatorInterfaceData | null>(null);
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setData([
        {
          id: 'OPERATORINTERFACE_001',
          name: 'Sample Operator Interface',
          status: 'ACTIVE',
  ...
  const handleSave = (formData: any) => {
    if (editingItem) {
      ...
      const newItem: OperatorInterfaceData = {
    ...
    <div className="page-container">
      ...
      <div className="main-content">
        <div className="page-header">
          ...
          <p>Operator workstation interface</p>
        </div>
        ...
        <div className="content-section">
          <div className="section-header">
            <h2>Operator Interface Management</h2>
        ...
        {showModal && (
          <CrudModal
            title={editingItem ? 'Edit Operator Interface' : 'Create Operator Interface'}
            fields={modalFields}
