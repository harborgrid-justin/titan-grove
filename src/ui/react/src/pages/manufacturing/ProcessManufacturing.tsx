...
interface ProcessManufacturingData {
  id: string;
  name: string;
...
const ProcessManufacturing: React.FC = () => {
  const [data, setData] = useState<ProcessManufacturingData[]>([]);
  const [showModal, setShowModal] = useState(false);
  const [editingItem, setEditingItem] = useState<ProcessManufacturingData | null>(null);
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setData([
        {
          id: 'PROCESSMANUFACTURING_001',
          name: 'Sample Progress Manufacturing',
          status: 'ACTIVE',
  ...
  const handleSave = (formData: any) => {
    if (editingItem) {
      ...
      const newItem: ProcessManufacturingData = {
    ...
    <div className="page-container">
      ...
      <div className="main-content">
        <div className="page-header">
          <h1>Progress Manufacturing</h1>
          <p>Manage process manufacturing operations</p>
        </div>
        ...
        <div className="content-section">
          <div className="section-header">
            <h2>Progress Manufacturing Management</h2>
        ...
        {showModal && (
          <CrudModal
            title={editingItem ? 'Edit Progress Manufacturing' : 'Create Progress Manufacturing'}
            fields={modalFields}
