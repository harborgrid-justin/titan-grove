...
interface ActivityBasedCostingData {
  id: string;
  name: string;
...
const ActivityBasedCosting: React.FC = () => {
  const [data, setData] = useState<ActivityBasedCostingData[]>([]);
  const [showModal, setShowModal] = useState(false);
  const [editingItem, setEditingItem] = useState<ActivityBasedCostingData | null>(null);
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setData([
        {
          id: 'ACTIVITYBASEDCOSTING_001',
          name: 'Sample Activity-Based Costing',
          status: 'ACTIVE',
  ...
  const handleSave = (formData: any) => {
    if (editingItem) {
      ...
      const newItem: ActivityBasedCostingData = {
    ...
    <div className="page-container">
      ...
      <div className="main-content">
        <div className="page-header">
          <h1>Activity-Based Costing</h1>
          <p>Activity-based cost management</p>
        </div>
        ...
        <div className="content-section">
          <div className="section-header">
            <h2>Activity-Based Costing Management</h2>
        ...
        {showModal && (
          <CrudModal
            title={editingItem ? 'Edit Activity-Based Costing' : 'Create Activity-Based Costing'}
            fields={modalFields}
...
export default ActivityBasedCosting;