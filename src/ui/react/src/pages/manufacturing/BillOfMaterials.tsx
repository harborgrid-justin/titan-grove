...
const BillOfMaterials: React.FC = () => {
  const [data, setData] = useState<BillOfMaterialsData[]>([]);
  const [showModal, setShowModal] = useState(false);
  const [editingItem, setEditingItem] = useState<BillOfMaterialsData | null>(null);
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setData([
        {
          id: 'BILLOFMATERIALS_001',
          name: 'Sample Bill of Materials',
          status: 'ACTIVE',
  ...
  const handleSave = (formData: any) => {
    if (editingItem) {
      ...
      const newItem: BillOfMaterialsData = {
  ...
  return (
    <div className="page-container">
      ...
      <div className="main-content">
        ...
        {showModal && (
          <CrudModal
            title={editingItem ? 'Edit Bill of Materials' : 'Create Bill of Materials'}
            fields={modalFields}
