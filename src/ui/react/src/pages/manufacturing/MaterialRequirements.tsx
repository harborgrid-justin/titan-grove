...
interface MaterialRequirementsData {
  id: string;
  name: string;
...
const MaterialRequirements: React.FC = () => {
  const [data, setData] = useState<MaterialRequirementsData[]>([]);
  const [showModal, setShowModal] = useState(false);
  const [editingItem, setEditingItem] = useState<MaterialRequirementsData | null>(null);
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setData([
        {
          id: 'MATERIALREQUIREMENTS_001',
          name: 'Sample Material Requirements Planning',
          status: 'ACTIVE',
  ...
  const handleSave = (formData: any) => {
    if (editingItem) {
      ...
      const newItem: MaterialRequirementsData = {
    ...
    <div className="page-container">
      ...
      <div className="main-content">
        <div className="page-header">
          ...
          <p>Plan material requirements</p>
        </div>
        ...
        <div className="content-section">
          <div className="section-header">
            <h2>Material Requirements Planning Management</h2>
        ...
        {showModal && (
          <CrudModal
            title={editingItem ? 'Edit Material Requirements Planning' : 'Create Material Requirements Planning'}
            fields={modalFields}
