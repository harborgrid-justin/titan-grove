...
const CostAnalytics: React.FC = () => {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setData([
        {
          id: 'COSTANALYTICS_001',
          name: 'Sample Cost Analytics',
          status: 'ACTIVE',
    ...
    <div className="page-container">
      ...
      <div className="main-content">
        <div className="page-header">
          ...
          <p>Manufacturing cost analysis</p>
        </div>
        ...
        <div className="content-section">
          <div className="section-header">
            <h2>Cost Analytics Management</h2>
        ...
        {showModal && (
          <CrudModal
            title={editingItem ? 'Edit Cost Analytics' : 'Create Cost Analytics'}
            fields={modalFields}
