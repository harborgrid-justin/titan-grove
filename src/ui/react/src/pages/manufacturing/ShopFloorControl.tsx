...
interface ShopFloorControlData {
  id: string;
  name: string;
...
const ShopFloorControl: React.FC = () => {
  const [data, setData] = useState<ShopFloorControlData[]>([]);
  const [showModal, setShowModal] = useState(false);
  const [editingItem, setEditingItem] = useState<ShopFloorControlData | null>(null);
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setData([
        {
          id: 'SHOPFLOORCONTROL_001',
          name: 'Sample Shop Floor Control',
          status: 'ACTIVE',
  ...
  const handleSave = (formData: any) => {
    if (editingItem) {
      ...
      const newItem: ShopFloorControlData = {
    ...
    <div className="page-container">
      ...
      <div className="main-content">
        <div className="page-header">
          ...
          <p>Control and monitor shop floor operations</p>
        </div>
        ...
        <div className="content-section">
          <div className="section-header">
            <h2>Shop Floor Control Management</h2>
        ...
        {showModal && (
          <CrudModal
            title={editingItem ? 'Edit Shop Floor Control' : 'Create Shop Floor Control'}
            fields={modalFields}
