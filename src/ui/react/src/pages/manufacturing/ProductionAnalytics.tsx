...
const ProductionAnalytics: React.FC = () => {
  ...
  const [editingItem, setEditingItem] = useState<ProductionAnalyticsData | null>(null);
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setData([
        {
          id: 'PRODUCTIONANALYTICS_001',
          name: 'Sample Production Analytics',
          status: 'ACTIVE',
  ...
  const handleSave = (formData: any) => {
    if (editingItem) {
      ...
      const newItem: ProductionAnalyticsData = {
    ...
    <div className="page-container">
      ...
      <div className="main-content">
        <div className="page-header">
          ...
          <p>Production performance analytics</p>
        </div>
        ...
        <div className="content-section">
          <div className="section-header">
            <h2>Production Analytics Management</h2>
        ...
        {showModal && (
          <CrudModal
            title={editingItem ? 'Edit Production Analytics' : 'Create Production Analytics'}
            fields={modalFields}
