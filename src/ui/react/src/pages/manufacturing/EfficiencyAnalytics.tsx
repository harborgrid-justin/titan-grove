...
interface EfficiencyAnalyticsData {
  id: string;
  name: string;
...
const EfficiencyAnalytics: React.FC = () => {
  const [data, setData] = useState<EfficiencyAnalyticsData[]>([]);
  const [showModal, setShowModal] = useState(false);
  const [editingItem, setEditingItem] = useState<EfficiencyAnalyticsData | null>(null);
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setData([
        {
          id: 'EFFICIENCYANALYTICS_001',
          name: 'Sample Efficiency Analytics',
          status: 'ACTIVE',
  ...
  const handleSave = (formData: any) => {
    if (editingItem) {
      ...
      const newItem: EfficiencyAnalyticsData = {
    ...
    <div className="page-container">
      ...
      <div className="main-content">
        <div className="page-header">
          ...
          <p>Manufacturing efficiency metrics</p>
        </div>
        ...
        <div className="content-section">
          <div className="section-header">
            <h2>Efficiency Analytics Management</h2>
        ...
        {showModal && (
          <CrudModal
            title={editingItem ? 'Edit Efficiency Analytics' : 'Create Efficiency Analytics'}
            fields={modalFields}
