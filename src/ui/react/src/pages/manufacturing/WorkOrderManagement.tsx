...
interface WorkOrderManagementData {
  id: string;
  name: string;
...
const WorkOrderManagement: React.FC = () => {
  const [data, setData] = useState<WorkOrderManagementData[]>([]);
  const [showModal, setShowModal] = useState(false);
  const [editingItem, setEditingItem] = useState<WorkOrderManagementData | null>(null);
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setData([
        {
          id: 'WORKORDERMANAGEMENT_001',
          name: 'Sample Work Order Management',
          status: 'ACTIVE',
  ...
  const handleSave = (formData: any) => {
    if (editingItem) {
      ...
      const newItem: WorkOrderManagementData = {
      ...
      <div className="main-content">
        ...
        <div className="content-section">
          <div className="section-header">
            <h2>Work Order Management Management</h2>
        ...
        {showModal && (
          <CrudModal
            title={editingItem ? 'Edit Work Order Management' : 'Create Work Order Management'}
            fields={modalFields}
