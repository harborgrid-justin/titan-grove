...
const InventoryTracking: React.FC = () => {
  const [data, setData] = useState<InventoryTrackingData[]>([]);
  const [showModal, setShowModal] = useState(false);
  const [editingItem, setEditingItem] = useState<InventoryTrackingData | null>(null);
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setData([
        {
          id: 'INVENTORYTRACKING_001',
          name: 'Sample Inventory Tracking',
          status: 'ACTIVE',
  ...
  const handleSave = (formData: any) => {
    if (editingItem) {
      ...
      const newItem: InventoryTrackingData = {
    ...
    <div className="page-container">
      ...
      <div className="main-content">
        <div className="page-header">
          ...
          <p>Track inventory movements on shop floor</p>
        </div>
        ...
        <div className="content-section">
          <div className="section-header">
            <h2>Inventory Tracking Management</h2>
        ...
        {showModal && (
          <CrudModal
            title={editingItem ? 'Edit Inventory Tracking' : 'Create Inventory Tracking'}
            fields={modalFields}
