...
interface ThroughputAnalysisData {
  id: string;
  name: string;
...
const ThroughputAnalysis: React.FC = () => {
  const [data, setData] = useState<ThroughputAnalysisData[]>([]);
  const [showModal, setShowModal] = useState(false);
  const [editingItem, setEditingItem] = useState<ThroughputAnalysisData | null>(null);
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setData([
        {
          id: 'THROUGHPUTANALYSIS_001',
          name: 'Sample Throughput Analysis',
          status: 'ACTIVE',
  ...
  const handleSave = (formData: any) => {
    if (editingItem) {
      ...
      const newItem: ThroughputAnalysisData = {
    ...
    <div className="page-container">
      ...
      <div className="main-content">
        <div className="page-header">
          ...
          <p>Production throughput analysis</p>
        </div>
        ...
        <div className="content-section">
          <div className="section-header">
            <h2>Throughput Analysis Management</h2>
        ...
        {showModal && (
          <CrudModal
            title={editingItem ? 'Edit Throughput Analysis' : 'Create Throughput Analysis'}
            fields={modalFields}
