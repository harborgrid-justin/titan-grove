...
const ToolManagement: React.FC = () => {
  const [data, setData] = useState<ToolManagementData[]>([]);
  const [showModal, setShowModal] = useState(false);
  const [editingItem, setEditingItem] = useState<ToolManagementData | null>(null);
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setData([
        {
          id: 'TOOLMANAGEMENT_001',
          name: 'Sample Tool Management',
          status: 'ACTIVE',
  ...
  const handleSave = (formData: any) => {
    if (editingItem) {
      ...
      const newItem: ToolManagementData = {
    ...
    <div className="page-container">
      ...
      <div className="main-content">
        <div className="page-header">
          ...
          <p>Manage manufacturing tools and fixtures</p>
        </div>
        ...
        <div className="content-section">
          <div className="section-header">
            <h2>Tool Management Management</h2>
        ...
        {showModal && (
          <CrudModal
            title={editingItem ? 'Edit Tool Management' : 'Create Tool Management'}
            fields={modalFields}
