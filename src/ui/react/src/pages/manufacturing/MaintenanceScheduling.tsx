...
interface MaintenanceSchedulingData {
  id: string;
  name: string;
...
const MaintenanceScheduling: React.FC = () => {
  const [data, setData] = useState<MaintenanceSchedulingData[]>([]);
  const [showModal, setShowModal] = useState(false);
  const [editingItem, setEditingItem] = useState<MaintenanceSchedulingData | null>(null);
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setData([
        {
          id: 'MAINTENANCESCHEDULING_001',
          name: 'Sample Maintenance Scheduling',
          status: 'ACTIVE',
  ...
  const handleSave = (formData: any) => {
    if (editingItem) {
      ...
      const newItem: MaintenanceSchedulingData = {
      ...
      <div className="main-content">
        ...
        <div className="content-section">
          <div className="section-header">
            <h2>Maintenance Scheduling Management</h2>
        ...
        {showModal && (
          <CrudModal
            title={editingItem ? 'Edit Maintenance Scheduling' : 'Create Maintenance Scheduling'}
            fields={modalFields}
