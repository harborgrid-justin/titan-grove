...
const EquipmentManagement: React.FC = () => {
  const [data, setData] = useState<EquipmentManagementData[]>([]);
  const [showModal, setShowModal] = useState(false);
  const [editingItem, setEditingItem] = useState<EquipmentManagementData | null>(null);
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setData([
        {
          id: 'EQUIPMENTMANAGEMENT_001',
          name: 'Sample Equipment Management',
          status: 'ACTIVE',
  ...
  const handleSave = (formData: any) => {
    if (editingItem) {
      ...
      const newItem: EquipmentManagementData = {
    ...
    <div className="page-container">
      ...
      <div className="main-content">
        <div className="page-header">
          ...
          <p>Manage manufacturing equipment</p>
        </div>
        ...
        <div className="content-section">
          <div className="section-header">
            <h2>Equipment Management Management</h2>
        ...
        {showModal && (
          <CrudModal
            title={editingItem ? 'Edit Equipment Management' : 'Create Equipment Management'}
            fields={modalFields}
