...
const CostRollup: React.FC = () => {
  const [data, setData] = useState<CostRollupData[]>([]);
  const [showModal, setShowModal] = useState(false);
  const [editingItem, setEditingItem] = useState<CostRollupData | null>(null);
    ...
    <div className="page-container">
      ...
      <div className="main-content">
        <div className="page-header">
          <h1>Cost Rollup</h1>
          <p>Product cost rollup and analysis</p>
        </div>
        ...
        {showModal && (
          <CrudModal
            title={editingItem ? 'Edit Cost Rollup' : 'Create Cost Rollup'}
            fields={modalFields}
