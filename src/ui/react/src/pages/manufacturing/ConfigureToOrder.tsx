...
interface ConfigureToOrderData {
  id: string;
  name: string;
...
const ConfigureToOrder: React.FC = () => {
  const [data, setData] = useState<ConfigureToOrderData[]>([]);
  const [showModal, setShowModal] = useState(false);
  const [editingItem, setEditingItem] = useState<ConfigureToOrderData | null>(null);
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setData([
        {
          id: 'CONFIGURETOORDER_001',
          name: 'Sample Configure-to-Order',
          status: 'ACTIVE',
  ...
  const handleSave = (formData: any) => {
    if (editingItem) {
      ...
      const newItem: ConfigureToOrderData = {
    ...
    <div className="page-container">
      ...
      <div className="main-content">
        <div className="page-header">
          <h1>Configure-to-Order</h1>
          <p>Manage configure-to-order production</p>
        </div>
        ...
        <div className="content-section">
          <div className="section-header">
            <h2>Configure-to-Order Management</h2>
        ...
        {showModal && (
          <CrudModal
            title={editingItem ? 'Edit Configure-to-Order' : 'Create Configure-to-Order'}
            fields={modalFields}
...
export default ConfigureToOrder;