...
interface SafetyManagementData {
  id: string;
  name: string;
...
const SafetyManagement: React.FC = () => {
  const [data, setData] = useState<SafetyManagementData[]>([]);
  const [showModal, setShowModal] = useState(false);
  const [editingItem, setEditingItem] = useState<SafetyManagementData | null>(null);
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setData([
        {
          id: 'SAFETYMANAGEMENT_001',
          name: 'Sample Safety Management',
          status: 'ACTIVE',
  ...
  const handleSave = (formData: any) => {
    if (editingItem) {
      ...
      const newItem: SafetyManagementData = {
    ...
    <div className="page-container">
      ...
      <div className="main-content">
        <div className="page-header">
          ...
          <p>Workplace safety management</p>
        </div>
        ...
        <div className="content-section">
          <div className="section-header">
            <h2>Safety Management Management</h2>
        ...
        {showModal && (
          <CrudModal
            title={editingItem ? 'Edit Safety Management' : 'Create Safety Management'}
            fields={modalFields}
