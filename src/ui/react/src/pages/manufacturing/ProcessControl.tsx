...
const ProcessControl: React.FC = () => {
  const [data, setData] = useState<ProcessControlData[]>([]);
  const [showModal, setShowModal] = useState(false);
  const [editingItem, setEditingItem] = useState<ProcessControlData | null>(null);
  ...
  const handleSave = (formData: any) => {
    if (editingItem) {
      ...
      const newItem: ProcessControlData = {
