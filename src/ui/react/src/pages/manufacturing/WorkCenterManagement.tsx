...
interface WorkCenterManagementData {
  id: string;
  name: string;
...
const WorkCenterManagement: React.FC = () => {
  const [data, setData] = useState<WorkCenterManagementData[]>([]);
  const [showModal, setShowModal] = useState(false);
  const [editingItem, setEditingItem] = useState<WorkCenterManagementData | null>(null);
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setData([
        {
          id: 'WORKCENTERMANAGEMENT_001',
          name: 'Sample Work Center Management',
          status: 'ACTIVE',
  ...
  const handleSave = (formData: any) => {
    if (editingItem) {
      ...
      const newItem: WorkCenterManagementData = {
    ...
    <div className="page-container">
      ...
      <div className="main-content">
        <div className="page-header">
          <h1>Work Center Management</h1>
          <p>Manage work centers and resources</p>
        </div>
        ...
        <div className="content-section">
          <div className="section-header">
            <h2>Work Center Management Management</h2>
        ...
        {showModal && (
          <CrudModal
            title={editingItem ? 'Edit Work Center Management' : 'Create Work Center Management'}
            fields={modalFields}
