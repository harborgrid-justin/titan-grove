...
const ProcessOptimization: React.FC = () => {
  const [data, setData] = useState<ProcessOptimizationData[]>([]);
  const [showModal, setShowModal] = useState(false);
  const [editingItem, setEditingItem] = useState<ProcessOptimizationData | null>(null);
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setData([
        {
          id: 'PROCESSOPTIMIZATION_001',
          name: 'Sample Progress Optimization',
          status: 'ACTIVE',
  ...
  const handleSave = (formData: any) => {
    if (editingItem) {
      ...
      const newItem: ProcessOptimizationData = {
    ...
    <div className="page-container">
      ...
      <div className="main-content">
        <div className="page-header">
          <h1>Progress Optimization</h1>
          <p>Optimize manufacturing processes</p>
        </div>
        ...
        <div className="content-section">
          <div className="section-header">
            <h2>Progress Optimization Management</h2>
        ...
        {showModal && (
          <CrudModal
            title={editingItem ? 'Edit Progress Optimization' : 'Create Progress Optimization'}
            fields={modalFields}
