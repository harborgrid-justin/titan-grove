...
interface ManufacturingCostsData {
  id: string;
  name: string;
...
const ManufacturingCosts: React.FC = () => {
  const [data, setData] = useState<ManufacturingCostsData[]>([]);
  const [showModal, setShowModal] = useState(false);
  const [editingItem, setEditingItem] = useState<ManufacturingCostsData | null>(null);
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setData([
        {
          id: 'MANUFACTURINGCOSTS_001',
          name: 'Sample Manufacturing Costs',
          status: 'ACTIVE',
  ...
  const handleSave = (formData: any) => {
    if (editingItem) {
      ...
      const newItem: ManufacturingCostsData = {
    ...
    <div className="page-container">
      ...
      <div className="main-content">
        <div className="page-header">
          <h1>Manufacturing Costs</h1>
          <p>Track and analyze manufacturing costs</p>
        </div>
        ...
        <div className="content-section">
          <div className="section-header">
            <h2>Manufacturing Costs Management</h2>
        ...
        {showModal && (
          <CrudModal
            title={editingItem ? 'Edit Manufacturing Costs' : 'Create Manufacturing Costs'}
            fields={modalFields}
