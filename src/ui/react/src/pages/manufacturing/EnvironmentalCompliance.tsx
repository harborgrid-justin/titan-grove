...
interface EnvironmentalComplianceData {
  id: string;
  name: string;
...
const EnvironmentalCompliance: React.FC = () => {
  const [data, setData] = useState<EnvironmentalComplianceData[]>([]);
  const [showModal, setShowModal] = useState(false);
  const [editingItem, setEditingItem] = useState<EnvironmentalComplianceData | null>(null);
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setData([
        {
          id: 'ENVIRONMENTALCOMPLIANCE_001',
          name: 'Sample Environmental CheckmarkOutline',
          status: 'ACTIVE',
  ...
  const handleSave = (formData: any) => {
    if (editingItem) {
      ...
      const newItem: EnvironmentalComplianceData = {
    ...
    <div className="page-container">
      ...
      <div className="main-content">
        <div className="page-header">
          <h1>Environmental CheckmarkOutline</h1>
        ...
        <div className="content-section">
          <div className="section-header">
            <h2>Environmental CheckmarkOutline Management</h2>
        ...
        {showModal && (
          <CrudModal
            title={editingItem ? 'Edit Environmental CheckmarkOutline' : 'Create Environmental CheckmarkOutline'}
            fields={modalFields}
