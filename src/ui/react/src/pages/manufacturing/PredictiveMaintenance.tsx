...
const PredictiveMaintenance: React.FC = () => {
  const [data, setData] = useState<PredictiveMaintenanceData[]>([]);
  const [showModal, setShowModal] = useState(false);
  const [editingItem, setEditingItem] = useState<PredictiveMaintenanceData | null>(null);
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setData([
        {
          id: 'PREDICTIVEMAINTENANCE_001',
          name: 'Sample Predictive Maintenance',
          status: 'ACTIVE',
  ...
  const handleSave = (formData: any) => {
    if (editingItem) {
      ...
      const newItem: PredictiveMaintenanceData = {
      ...
      <div className="main-content">
        ...
        <div className="content-section">
          <div className="section-header">
            <h2>Predictive Maintenance Management</h2>
        ...
        {showModal && (
          <CrudModal
            title={editingItem ? 'Edit Predictive Maintenance' : 'Create Predictive Maintenance'}
            fields={modalFields}
