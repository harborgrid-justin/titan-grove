...
const QualityInspection: React.FC = () => {
  const [data, setData] = useState<QualityInspectionData[]>([]);
  const [showModal, setShowModal] = useState(false);
  const [editingItem, setEditingItem] = useState<QualityInspectionData | null>(null);
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setData([
        {
          id: 'QUALITYINSPECTION_001',
          name: 'Sample Quality Inspection',
          status: 'ACTIVE',
  ...
  const handleSave = (formData: any) => {
    if (editingItem) {
      ...
      const newItem: QualityInspectionData = {
    ...
    <div className="page-container">
      ...
      <div className="main-content">
        <div className="page-header">
          ...
          <p>Manage quality inspections and tests</p>
        </div>
        ...
        <div className="content-section">
          <div className="section-header">
            <h2>Quality Inspection Management</h2>
        ...
        {showModal && (
          <CrudModal
            title={editingItem ? 'Edit Quality Inspection' : 'Create Quality Inspection'}
            fields={modalFields}
