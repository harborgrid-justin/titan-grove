...
interface MachineMonitoringData {
  id: string;
  name: string;
...
const MachineMonitoring: React.FC = () => {
  const [data, setData] = useState<MachineMonitoringData[]>([]);
  const [showModal, setShowModal] = useState(false);
  const [editingItem, setEditingItem] = useState<MachineMonitoringData | null>(null);
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setData([
        {
          id: 'MACHINEMONITORING_001',
          name: 'Sample Machine Monitoring',
          status: 'ACTIVE',
  ...
  const handleSave = (formData: any) => {
    if (editingItem) {
      ...
      const newItem: MachineMonitoringData = {
    ...
    <div className="page-container">
      ...
      <div className="main-content">
        <div className="page-header">
          ...
          <p>Monitor machine status and performance</p>
        </div>
        ...
        <div className="content-section">
          <div className="section-header">
            <h2>Machine Monitoring Management</h2>
        ...
        {showModal && (
          <CrudModal
            title={editingItem ? 'Edit Machine Monitoring' : 'Create Machine Monitoring'}
            fields={modalFields}
