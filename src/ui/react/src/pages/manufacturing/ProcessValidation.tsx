...
interface ProcessValidationData {
  id: string;
  name: string;
...
const ProcessValidation: React.FC = () => {
  const [data, setData] = useState<ProcessValidationData[]>([]);
  const [showModal, setShowModal] = useState(false);
  const [editingItem, setEditingItem] = useState<ProcessValidationData | null>(null);
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setData([
        {
          id: 'PROCESSVALIDATION_001',
          name: 'Sample Progress Validation',
          status: 'ACTIVE',
  ...
  const handleSave = (formData: any) => {
    if (editingItem) {
      ...
      const newItem: ProcessValidationData = {
    ...
    <div className="page-container">
      ...
      <div className="main-content">
        <div className="page-header">
          ...
          <p>Validate manufacturing processes</p>
        </div>
        ...
        <div className="content-section">
          <div className="section-header">
            <h2>Progress Validation Management</h2>
        ...
        {showModal && (
          <CrudModal
            title={editingItem ? 'Edit Progress Validation' : 'Create Progress Validation'}
            fields={modalFields}
