...
const RegulatoryCompliance: React.FC = () => {
  const [data, setData] = useState<RegulatoryComplianceData[]>([]);
  const [showModal, setShowModal] = useState(false);
  const [editingItem, setEditingItem] = useState<RegulatoryComplianceData | null>(null);
  ...
  const handleSave = (formData: any) => {
    if (editingItem) {
      ...
      const newItem: RegulatoryComplianceData = {
