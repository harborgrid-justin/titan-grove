...
const ProductionControl: React.FC = () => {
  const [data, setData] = useState<ProductionControlData[]>([]);
  const [showModal, setShowModal] = useState(false);
  const [editingItem, setEditingItem] = useState<ProductionControlData | null>(null);
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setData([
        {
          id: 'PRODUCTIONCONTROL_001',
          name: 'Sample Production Control',
          status: 'ACTIVE',
  ...
  const handleSave = (formData: any) => {
    if (editingItem) {
      ...
      const newItem: ProductionControlData = {
    ...
    <div className="page-container">
      ...
      <div className="main-content">
        <div className="page-header">
          ...
          <p>Monitor and control production processes</p>
        </div>
        ...
        <div className="content-section">
          <div className="section-header">
            <h2>Production Control Management</h2>
        ...
        {showModal && (
          <CrudModal
            title={editingItem ? 'Edit Production Control' : 'Create Production Control'}
            fields={modalFields}
