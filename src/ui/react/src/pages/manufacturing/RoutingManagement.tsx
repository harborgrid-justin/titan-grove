...
interface RoutingManagementData {
  id: string;
  name: string;
...
const RoutingManagement: React.FC = () => {
  const [data, setData] = useState<RoutingManagementData[]>([]);
  const [showModal, setShowModal] = useState(false);
  const [editingItem, setEditingItem] = useState<RoutingManagementData | null>(null);
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setData([
        {
          id: 'ROUTINGMANAGEMENT_001',
          name: 'Sample Routing Management',
          status: 'ACTIVE',
  ...
  const handleSave = (formData: any) => {
    if (editingItem) {
      ...
      const newItem: RoutingManagementData = {
    ...
    <div className="page-container">
      ...
      <div className="main-content">
        <div className="page-header">
          ...
          <p>Define production routing and operations</p>
        </div>
        ...
        <div className="content-section">
          <div className="section-header">
            <h2>Routing Management Management</h2>
        ...
        {showModal && (
          <CrudModal
            title={editingItem ? 'Edit Routing Management' : 'Create Routing Management'}
            fields={modalFields}
