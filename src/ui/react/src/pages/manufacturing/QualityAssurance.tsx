...
const QualityAssurance: React.FC = () => {
  const [data, setData] = useState<QualityAssuranceData[]>([]);
  const [showModal, setShowModal] = useState(false);
  const [editingItem, setEditingItem] = useState<QualityAssuranceData | null>(null);
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setData([
        {
          id: 'QUALITYASSURANCE_001',
          name: 'Sample Quality Assurance',
          status: 'ACTIVE',
  ...
  const handleSave = (formData: any) => {
    if (editingItem) {
      ...
      const newItem: QualityAssuranceData = {
    ...
    <div className="page-container">
      ...
      <div className="main-content">
        <div className="page-header">
          ...
          <p>Quality assurance processes and procedures</p>
        </div>
        ...
        <div className="content-section">
          <div className="section-header">
            <h2>Quality Assurance Management</h2>
        ...
        {showModal && (
          <CrudModal
            title={editingItem ? 'Edit Quality Assurance' : 'Create Quality Assurance'}
            fields={modalFields}
