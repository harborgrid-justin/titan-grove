...
router.post('/problem-management/solution-development', supportController.developSolution);
...
router.post('/change-management/change-advisory-board', supportController.scheduleCABMeeting);

router.get('/change-management/change-risk-assessment', supportController.getChangeRiskAssessment);
router.post('/change-management/change-risk-assessment', supportController.assessChangeRisk);

router.get('/change-management/change-implementation', supportController.getChangeImplementation);
router.post('/change-management/change-implementation', supportController.implementChange);

router.get('/change-management/emergency-changes', supportController.getEmergencyChanges);
router.post('/change-management/emergency-changes', supportController.createEmergencyChange);

router.get('/change-management/change-calendar', supportController.getChangeCalendar);
router.post('/change-management/change-calendar', supportController.scheduleChange);
...
router.post('/knowledge-management/knowledge-search', supportController.searchKnowledge);
...
router.post('/service-level-management/sla-definition', supportController.createSLA);
...
router.post('/support-analytics/customer-satisfaction', supportController.recordSatisfactionScore);
...
router.post('/support-analytics/custom-reporting', supportController.createCustomReport);

// Configuration endpoints
router.get('/config', supportController.getGlobalConfig);
router.put('/config', supportController.updateGlobalConfig);
