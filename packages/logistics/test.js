/**
 * Test for @titan-grove/logistics module
 */

const functions = require('./index.js');

console.log('🧪 Testing @titan-grove/logistics Module');
console.log('==========================================');
...
try {
  ...
  // Test hello function
  if (functions.hello_logistics) {
    console.log('✅ Hello function:', functions.hello_logistics());
  }
  ...
  console.log('');
  console.log('🎉 Logistics Management Module Test Completed Successfully!');
  console.log('');
  console.log('📈 Performance Benefits:');
  console.log('   • Native Rust calculations for maximum speed');
  console.log('   • Enterprise-grade logistics management features');
