...
const { BlockchainRecord } = require('./index.js');

console.log('🧪 Testing @titan-grove/blockchain');
console.log('===============================');
...
try {
  ...
  const record = new BlockchainRecord(
    ...
    'Test description for Blockchain Management',
    'Active'
  );
  ...
  console.log('🎉 All tests passed for @titan-grove/blockchain');
