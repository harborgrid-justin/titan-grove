/**
 * Test for @titan-grove/risk module
 */

const functions = require('./index.js');

console.log('🧪 Testing @titan-grove/risk Module');
console.log('==========================================');
...
try {
  ...
  // Test hello function
  if (functions.hello_risk) {
    console.log('✅ Hello function:', functions.hello_risk());
  }
  ...
  console.log('');
  console.log('🎉 Risk Management Module Test Completed Successfully!');
  console.log('');
  console.log('📈 Performance Benefits:');
  console.log('   • Native Rust calculations for maximum speed');
  console.log('   • Enterprise-grade risk management features');
