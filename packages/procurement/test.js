/**
 * Test for @titan-grove/procurement module
 */

const functions = require('./index.js');

console.log('🧪 Testing @titan-grove/procurement Module');
console.log('==========================================');
...
try {
  ...
  // Test hello function
  if (functions.hello_procurement) {
    console.log('✅ Hello function:', functions.hello_procurement());
  }
  ...
  console.log('');
  console.log('🎉 Procurement Module Test Completed Successfully!');
  console.log('');
  console.log('📈 Performance Benefits:');
  console.log('   • Native Rust calculations for maximum speed');
  console.log('   • Enterprise-grade procurement features');
